...
var opts = { 
  'effectiveAt': new Date("2013-10-20T19:20:30+01:00"), // Date | Optional. The effective date of the deletion
  'portfolioPropertyKeys': ["portfolioPropertyKeys_example"] // [String] | Optional. The keys of the properties to be deleted. None specified indicates the intention to delete all properties from the portfolio
};
...
var opts = { 
  'request': new LusidSdk.UpdatePortfolioRequest(), // UpdatePortfolioRequest | The updated portfolio definition
...
var opts = { 
  'portfolioProperties': null, // Object | The property values to be upserted to the portfolio
