...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Link', 'model/Transaction', 'model/Version'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Link'), require('./Transaction'), require('./Version'));
  } else {
    // Browser globals (root is window)
    if (!root.LusidSdk) {
      root.LusidSdk = {};
    }
    root.LusidSdk.VersionedResourceListOfTransaction = factory(root.LusidSdk.ApiClient, root.LusidSdk.Link, root.LusidSdk.Transaction, root.LusidSdk.Version);
  }
}(this, function(ApiClient, Link, Transaction, Version) {
  'use strict';
  ...
  /**
   * The VersionedResourceListOfTransaction model module.
   * @module model/VersionedResourceListOfTransaction
   * @version 0.9.189
   */

  /**
   * Constructs a new <code>VersionedResourceListOfTransaction</code>.
   * @alias module:model/VersionedResourceListOfTransaction
   * @class
   */
  ...
  /**
   * Constructs a <code>VersionedResourceListOfTransaction</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/VersionedResourceListOfTransaction} obj Optional instance to populate.
   * @return {module:model/VersionedResourceListOfTransaction} The populated <code>VersionedResourceListOfTransaction</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('values')) {
        obj['values'] = ApiClient.convertToType(data['values'], [Transaction]);
      }
  ...
  /**
   * @member {Array.<module:model/Transaction>} values
   */
