...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Link', 'model/PortfolioHolding', 'model/Version'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Link'), require('./PortfolioHolding'), require('./Version'));
  } else {
    // Browser globals (root is window)
    if (!root.LusidSdk) {
      root.LusidSdk = {};
    }
    root.LusidSdk.VersionedResourceListOfPortfolioHolding = factory(root.LusidSdk.ApiClient, root.LusidSdk.Link, root.LusidSdk.PortfolioHolding, root.LusidSdk.Version);
  }
}(this, function(ApiClient, Link, PortfolioHolding, Version) {
  'use strict';
  ...
  /**
   * The VersionedResourceListOfPortfolioHolding model module.
   * @module model/VersionedResourceListOfPortfolioHolding
   * @version 0.9.189
   */

  /**
   * Constructs a new <code>VersionedResourceListOfPortfolioHolding</code>.
   * @alias module:model/VersionedResourceListOfPortfolioHolding
   * @class
   */
  ...
  /**
   * Constructs a <code>VersionedResourceListOfPortfolioHolding</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/VersionedResourceListOfPortfolioHolding} obj Optional instance to populate.
   * @return {module:model/VersionedResourceListOfPortfolioHolding} The populated <code>VersionedResourceListOfPortfolioHolding</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('values')) {
        obj['values'] = ApiClient.convertToType(data['values'], [PortfolioHolding]);
      }
  ...
  /**
   * @member {Array.<module:model/PortfolioHolding>} values
   */
