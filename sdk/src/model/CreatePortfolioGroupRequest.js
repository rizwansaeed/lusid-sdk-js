...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.LusidSdk.CreatePortfolioGroupRequest = factory(root.LusidSdk.ApiClient, root.LusidSdk.ResourceId);
  }
  ...
  /**
   * The CreatePortfolioGroupRequest model module.
   * @module model/CreatePortfolioGroupRequest
   * @version 0.9.189
   */

  /**
   * Constructs a new <code>CreatePortfolioGroupRequest</code>.
   * @alias module:model/CreatePortfolioGroupRequest
   * @class
   * @param id {String} 
   * @param displayName {String} 
   */
  var exports = function(id, displayName) {
    var _this = this;
  ...
  /**
   * Constructs a <code>CreatePortfolioGroupRequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CreatePortfolioGroupRequest} obj Optional instance to populate.
   * @return {module:model/CreatePortfolioGroupRequest} The populated <code>CreatePortfolioGroupRequest</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('values')) {
        obj['values'] = ApiClient.convertToType(data['values'], [ResourceId]);
      }
  ...
  /**
   * @member {Array.<module:model/ResourceId>} values
   */
