...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.LusidSdk.CreatePropertyDefinitionRequest = factory(root.LusidSdk.ApiClient, root.LusidSdk.ResourceId);
  }
  ...
  /**
   * The CreatePropertyDefinitionRequest model module.
   * @module model/CreatePropertyDefinitionRequest
   * @version 0.9.189
   */

  /**
   * Constructs a new <code>CreatePropertyDefinitionRequest</code>.
   * @alias module:model/CreatePropertyDefinitionRequest
   * @class
   */
  ...
  /**
   * Constructs a <code>CreatePropertyDefinitionRequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CreatePropertyDefinitionRequest} obj Optional instance to populate.
   * @return {module:model/CreatePropertyDefinitionRequest} The populated <code>CreatePropertyDefinitionRequest</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('dataTypeId')) {
        obj['dataTypeId'] = ResourceId.constructFromObject(data['dataTypeId']);
      }
  ...
  /**
   * @member {module:model/CreatePropertyDefinitionRequest.DomainEnum} domain
   */
  ...
  /**
   * @member {module:model/ResourceId} dataTypeId
   */
  exports.prototype['dataTypeId'] = undefined;
  /**
   * @member {module:model/CreatePropertyDefinitionRequest.LifeTimeEnum} lifeTime
   */
  exports.prototype['lifeTime'] = undefined;
  /**
   * @member {module:model/CreatePropertyDefinitionRequest.TypeEnum} type
   */
