...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.LusidSdk.ResourceListOfValueType = factory(root.LusidSdk.ApiClient, root.LusidSdk.Link);
  }
  ...
  /**
   * The ResourceListOfValueType model module.
   * @module model/ResourceListOfValueType
   * @version 0.9.189
   */

  /**
   * Constructs a new <code>ResourceListOfValueType</code>.
   * @alias module:model/ResourceListOfValueType
   * @class
   */
  ...
  /**
   * Constructs a <code>ResourceListOfValueType</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ResourceListOfValueType} obj Optional instance to populate.
   * @return {module:model/ResourceListOfValueType} The populated <code>ResourceListOfValueType</code> instance.
   */
  ...
  /**
   * @member {Array.<module:model/ResourceListOfValueType.ValuesEnum>} values
   */
