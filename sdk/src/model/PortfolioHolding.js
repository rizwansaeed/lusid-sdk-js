...
(function(root, factory) {
   ...
   * @param cost {module:model/CurrencyAndAmount} Book cost of holding in transaction currency
   * @param costPortfolioCcy {module:model/CurrencyAndAmount} Book cost of holding in portfolio currency
   */
