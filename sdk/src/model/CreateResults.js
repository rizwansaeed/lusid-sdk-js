...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.LusidSdk.CreateResults = factory(root.LusidSdk.ApiClient);
  }
  ...
  /**
   * The CreateResults model module.
   * @module model/CreateResults
   * @version 0.9.189
   */

  /**
   * Constructs a new <code>CreateResults</code>.
   * @alias module:model/CreateResults
   * @class
   */
  ...
  /**
   * Constructs a <code>CreateResults</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CreateResults} obj Optional instance to populate.
   * @return {module:model/CreateResults} The populated <code>CreateResults</code> instance.
   */
  ...
  /**
   * The key is a unique point in 'run' space. For a given scope and time point, one would wish to  identify a unique result set for a given recipe. In essence, this key is the unique identifier for the tuple (recipe,portfolios)  However, that only matters when one is trying to use it automatically to retrieve them.  A question becomes whether we would wish to store groups of protfolio results together, or only single ones.  Also, whether we would accept uploading of groups and then split them apart.
   * @member {String} key
   */
   ...
   * @member {module:model/CreateResults.FormatEnum} format
   */
