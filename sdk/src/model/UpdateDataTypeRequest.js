...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.LusidSdk.UpdateDataTypeRequest = factory(root.LusidSdk.ApiClient, root.LusidSdk.CreateUnitDefinition);
  }
  ...
  /**
   * The UpdateDataTypeRequest model module.
   * @module model/UpdateDataTypeRequest
   * @version 0.9.189
   */

  /**
   * Constructs a new <code>UpdateDataTypeRequest</code>.
   * @alias module:model/UpdateDataTypeRequest
   * @class
   * @param typeValueRange {module:model/UpdateDataTypeRequest.TypeValueRangeEnum} 
   * @param displayName {String} 
   * @param description {String} 
   * @param valueType {module:model/UpdateDataTypeRequest.ValueTypeEnum} 
   */
  var exports = function(typeValueRange, displayName, description, valueType) {
    var _this = this;
  ...
  /**
   * Constructs a <code>UpdateDataTypeRequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/UpdateDataTypeRequest} obj Optional instance to populate.
   * @return {module:model/UpdateDataTypeRequest} The populated <code>UpdateDataTypeRequest</code> instance.
   */
  ...
  /**
   * @member {module:model/UpdateDataTypeRequest.TypeValueRangeEnum} typeValueRange
   */
  ...
  /**
   * @member {module:model/UpdateDataTypeRequest.ValueTypeEnum} valueType
   */
  ...
  /**
   * @member {module:model/UpdateDataTypeRequest.UnitSchemaEnum} unitSchema
   */
