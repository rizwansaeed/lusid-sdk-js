...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/MetricValue', 'model/QuoteId', 'model/QuoteLineage'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./MetricValue'), require('./QuoteId'), require('./QuoteLineage'));
  } else {
    // Browser globals (root is window)
    if (!root.LusidSdk) {
      root.LusidSdk = {};
    }
    root.LusidSdk.UpsertQuoteRequest = factory(root.LusidSdk.ApiClient, root.LusidSdk.MetricValue, root.LusidSdk.QuoteId, root.LusidSdk.QuoteLineage);
  }
}(this, function(ApiClient, MetricValue, QuoteId, QuoteLineage) {
  'use strict';
  ...
  /**
   * The UpsertQuoteRequest model module.
   * @module model/UpsertQuoteRequest
   * @version 0.9.189
   */

  /**
   * Constructs a new <code>UpsertQuoteRequest</code>.
   * @alias module:model/UpsertQuoteRequest
   * @class
   * @param quoteId {module:model/QuoteId} 
   * @param metricValue {module:model/MetricValue} 
   * @param quoteLineage {module:model/QuoteLineage} 
   * @param effectiveAt {Date} 
   */
  var exports = function(quoteId, metricValue, quoteLineage, effectiveAt) {
    var _this = this;

    _this['quoteId'] = quoteId;
    _this['metricValue'] = metricValue;
    _this['quoteLineage'] = quoteLineage;
    _this['effectiveAt'] = effectiveAt;
  };

  /**
   * Constructs a <code>UpsertQuoteRequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/UpsertQuoteRequest} obj Optional instance to populate.
   * @return {module:model/UpsertQuoteRequest} The populated <code>UpsertQuoteRequest</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('quoteLineage')) {
        obj['quoteLineage'] = QuoteLineage.constructFromObject(data['quoteLineage']);
      }
  ...
  /**
   * 
   * @member {module:model/QuoteLineage} quoteLineage
   */
  exports.prototype['quoteLineage'] = undefined;
  /**
   * 
