...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.LusidSdk.PortfolioDetails = factory(root.LusidSdk.ApiClient, root.LusidSdk.Link, root.LusidSdk.ResourceId, root.LusidSdk.Version);
  }
  ...
  /**
   * The PortfolioDetails model module.
   * @module model/PortfolioDetails
   * @version 0.9.189
   */

  /**
   * Constructs a new <code>PortfolioDetails</code>.
   * @alias module:model/PortfolioDetails
   * @class
   */
  ...
  /**
   * Constructs a <code>PortfolioDetails</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PortfolioDetails} obj Optional instance to populate.
   * @return {module:model/PortfolioDetails} The populated <code>PortfolioDetails</code> instance.
   */
