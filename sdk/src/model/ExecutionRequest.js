...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.LusidSdk.ExecutionRequest = factory(root.LusidSdk.ApiClient);
  }
   ...
   * @class
   * @param executionId {String} FIX Field 17.  Unique execution identifier.
   * @param side {String} FIX Field 54.
   * @param instrumentIdentifiers {Object.<String, String>} Unique instrument identifiers.
   * @param transactionTime {Date} FIX field 60.  Time the transaction represented by this ExecutionReport occurred.
   * @param lastShares {Number} FIX field 32.
   * @param lastPx {Number} FIX field 31.
   * @param currency {String} FIX field 15.
   */
  var exports = function(executionId, side, instrumentIdentifiers, transactionTime, lastShares, lastPx, currency) {
    var _this = this;

    _this['executionId'] = executionId;
    _this['side'] = side;
    _this['instrumentIdentifiers'] = instrumentIdentifiers;
    _this['transactionTime'] = transactionTime;
    _this['lastShares'] = lastShares;
    _this['lastPx'] = lastPx;
   ...
   */
  exports.prototype['lastShares'] = undefined;
  /**
   * FIX field 31.
