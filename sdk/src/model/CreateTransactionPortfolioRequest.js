...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/PropertyValue', 'model/ResourceId'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./PropertyValue'), require('./ResourceId'));
  } else {
    // Browser globals (root is window)
    if (!root.LusidSdk) {
      root.LusidSdk = {};
    }
    root.LusidSdk.CreateTransactionPortfolioRequest = factory(root.LusidSdk.ApiClient, root.LusidSdk.PropertyValue, root.LusidSdk.ResourceId);
  }
}(this, function(ApiClient, PropertyValue, ResourceId) {
  'use strict';
  ...
  /**
   * The CreateTransactionPortfolioRequest model module.
   * @module model/CreateTransactionPortfolioRequest
   * @version 0.9.189
   */

  /**
   * Constructs a new <code>CreateTransactionPortfolioRequest</code>.
   * @alias module:model/CreateTransactionPortfolioRequest
   * @class
   * @param displayName {String} 
   * @param code {String} 
   * @param baseCurrency {String} 
   */
  var exports = function(displayName, code, baseCurrency) {
    var _this = this;
  ...
  /**
   * Constructs a <code>CreateTransactionPortfolioRequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CreateTransactionPortfolioRequest} obj Optional instance to populate.
   * @return {module:model/CreateTransactionPortfolioRequest} The populated <code>CreateTransactionPortfolioRequest</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('properties')) {
        obj['properties'] = ApiClient.convertToType(data['properties'], {'String': PropertyValue});
      }
    }
    return obj;
  }
  ...
  /**
   * 
   * @member {module:model/CreateTransactionPortfolioRequest.AccountingMethodEnum} accountingMethod
   */
   ...
   * @member {Object.<String, module:model/PropertyValue>} properties
   */
