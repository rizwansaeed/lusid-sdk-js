...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.LusidSdk.TargetTaxLot = factory(root.LusidSdk.ApiClient, root.LusidSdk.CurrencyAndAmount);
  }
  ...
  /**
   * The TargetTaxLot model module.
   * @module model/TargetTaxLot
   * @version 0.9.189
   */

  /**
   * Constructs a new <code>TargetTaxLot</code>.
   * Used to specify holdings target amounts at the tax-lot level
   * @alias module:model/TargetTaxLot
   * @class
  ...
  /**
   * Constructs a <code>TargetTaxLot</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/TargetTaxLot} obj Optional instance to populate.
   * @return {module:model/TargetTaxLot} The populated <code>TargetTaxLot</code> instance.
   */
