...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ErrorDetailBase'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ErrorDetailBase'));
  } else {
    // Browser globals (root is window)
    if (!root.LusidSdk) {
      root.LusidSdk = {};
    }
    root.LusidSdk.ErrorResponse = factory(root.LusidSdk.ApiClient, root.LusidSdk.ErrorDetailBase);
  }
}(this, function(ApiClient, ErrorDetailBase) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('detailedMessage')) {
        obj['detailedMessage'] = ApiClient.convertToType(data['detailedMessage'], 'String');
      }
      if (data.hasOwnProperty('items')) {
        obj['items'] = ApiClient.convertToType(data['items'], [ErrorDetailBase]);
      }
   ...
   */
  exports.prototype['detailedMessage'] = undefined;
  /**
   * @member {Array.<module:model/ErrorDetailBase>} items
   */
  ...
  exports.CodeEnum = {
    ...
    /**
     * value: "PropertyNotFound"
     * @const
     */
    "PropertyNotFound": "PropertyNotFound",
    /**
     * value: "PortfolioRecursionDepth"
     * @const
     */
