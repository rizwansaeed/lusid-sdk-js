...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/PerpetualProperty', 'model/TransactionPropertyMapping'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./PerpetualProperty'), require('./TransactionPropertyMapping'));
  } else {
    // Browser globals (root is window)
    if (!root.LusidSdk) {
      root.LusidSdk = {};
    }
    root.LusidSdk.TransactionConfigurationMovementData = factory(root.LusidSdk.ApiClient, root.LusidSdk.PerpetualProperty, root.LusidSdk.TransactionPropertyMapping);
  }
}(this, function(ApiClient, PerpetualProperty, TransactionPropertyMapping) {
  'use strict';
  ...
  /**
   * The TransactionConfigurationMovementData model module.
   * @module model/TransactionConfigurationMovementData
   * @version 0.9.189
   */

  /**
   * Constructs a new <code>TransactionConfigurationMovementData</code>.
   * @alias module:model/TransactionConfigurationMovementData
   * @class
   * @param movementTypes {module:model/TransactionConfigurationMovementData.MovementTypesEnum} The Movement Types
   * @param side {module:model/TransactionConfigurationMovementData.SideEnum} The Movement Side
  ...
  /**
   * Constructs a <code>TransactionConfigurationMovementData</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/TransactionConfigurationMovementData} obj Optional instance to populate.
   * @return {module:model/TransactionConfigurationMovementData} The populated <code>TransactionConfigurationMovementData</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('mappings')) {
        obj['mappings'] = ApiClient.convertToType(data['mappings'], [TransactionPropertyMapping]);
      }
    }
    return obj;
  }
  ...
  /**
   * The Movement Types
   * @member {module:model/TransactionConfigurationMovementData.MovementTypesEnum} movementTypes
   */
  exports.prototype['movementTypes'] = undefined;
  /**
   * The Movement Side
   * @member {module:model/TransactionConfigurationMovementData.SideEnum} side
   */
  ...
  /**
   * @member {Array.<module:model/TransactionPropertyMapping>} mappings
   */
