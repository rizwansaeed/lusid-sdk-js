...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ReferencePortfolioConstituentRequest'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ReferencePortfolioConstituentRequest'));
  } else {
    // Browser globals (root is window)
    if (!root.LusidSdk) {
      root.LusidSdk = {};
    }
    root.LusidSdk.UpsertReferencePortfolioConstituentsRequest = factory(root.LusidSdk.ApiClient, root.LusidSdk.ReferencePortfolioConstituentRequest);
  }
}(this, function(ApiClient, ReferencePortfolioConstituentRequest) {
  'use strict';
  ...
  /**
   * The UpsertReferencePortfolioConstituentsRequest model module.
   * @module model/UpsertReferencePortfolioConstituentsRequest
   * @version 0.9.189
   */

  /**
   * Constructs a new <code>UpsertReferencePortfolioConstituentsRequest</code>.
   * @alias module:model/UpsertReferencePortfolioConstituentsRequest
   * @class
   * @param effectiveFrom {Date} 
   * @param weightType {module:model/UpsertReferencePortfolioConstituentsRequest.WeightTypeEnum} 
   * @param constituents {Array.<module:model/ReferencePortfolioConstituentRequest>} Set of constituents (instrument/weight pairings)
   */
  var exports = function(effectiveFrom, weightType, constituents) {
    var _this = this;

    _this['effectiveFrom'] = effectiveFrom;
    _this['weightType'] = weightType;


    _this['constituents'] = constituents;
  };

  /**
   * Constructs a <code>UpsertReferencePortfolioConstituentsRequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/UpsertReferencePortfolioConstituentsRequest} obj Optional instance to populate.
   * @return {module:model/UpsertReferencePortfolioConstituentsRequest} The populated <code>UpsertReferencePortfolioConstituentsRequest</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('weightType')) {
        obj['weightType'] = ApiClient.convertToType(data['weightType'], 'String');
      }
      ...
      if (data.hasOwnProperty('constituents')) {
        obj['constituents'] = ApiClient.convertToType(data['constituents'], [ReferencePortfolioConstituentRequest]);
      }
    }
    return obj;
  }
  ...
  /**
   * 
   * @member {module:model/UpsertReferencePortfolioConstituentsRequest.WeightTypeEnum} weightType
   */
  exports.prototype['weightType'] = undefined;
  /**
   * 
   * @member {module:model/UpsertReferencePortfolioConstituentsRequest.PeriodTypeEnum} periodType
   */
   ...
   */
  exports.prototype['periodCount'] = undefined;
  /**
   * Set of constituents (instrument/weight pairings)
   * @member {Array.<module:model/ReferencePortfolioConstituentRequest>} constituents
   */
  exports.prototype['constituents'] = undefined;


  /**
   * Allowed values for the <code>weightType</code> property.
   * @enum {String}
   * @readonly
   */
  exports.WeightTypeEnum = {
    /**
     * value: "Static"
     * @const
     */
