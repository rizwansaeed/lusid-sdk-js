...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.LusidSdk.TransactionConfigurationTypeAlias = factory(root.LusidSdk.ApiClient);
  }
  ...
  /**
   * The TransactionConfigurationTypeAlias model module.
   * @module model/TransactionConfigurationTypeAlias
   * @version 0.9.189
   */

  /**
   * Constructs a new <code>TransactionConfigurationTypeAlias</code>.
   * @alias module:model/TransactionConfigurationTypeAlias
   * @class
   * @param type {String} The transaction type
   * @param description {String} Brief description of the transaction
   * @param transactionClass {String} Relates types of a similar class. E.g. Buy/Sell, StockIn/StockOut
   * @param transactionGroup {String} Group is a set of codes related to a source, or sync
   * @param transactionRoles {module:model/TransactionConfigurationTypeAlias.TransactionRolesEnum} Transactions role within a class. E.g. Increase a long position
   */
  var exports = function(type, description, transactionClass, transactionGroup, transactionRoles) {
    var _this = this;

    _this['type'] = type;
    _this['description'] = description;
    _this['transactionClass'] = transactionClass;
    _this['transactionGroup'] = transactionGroup;
    _this['transactionRoles'] = transactionRoles;
  };

  /**
   * Constructs a <code>TransactionConfigurationTypeAlias</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/TransactionConfigurationTypeAlias} obj Optional instance to populate.
   * @return {module:model/TransactionConfigurationTypeAlias} The populated <code>TransactionConfigurationTypeAlias</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('transactionGroup')) {
        obj['transactionGroup'] = ApiClient.convertToType(data['transactionGroup'], 'String');
      }
      if (data.hasOwnProperty('transactionRoles')) {
        obj['transactionRoles'] = ApiClient.convertToType(data['transactionRoles'], 'String');
      }
    }
    return obj;
  }
   ...
   * @member {String} transactionGroup
   */
  exports.prototype['transactionGroup'] = undefined;
  /**
   * Transactions role within a class. E.g. Increase a long position
   * @member {module:model/TransactionConfigurationTypeAlias.TransactionRolesEnum} transactionRoles
   */
  exports.prototype['transactionRoles'] = undefined;


  /**
   * Allowed values for the <code>transactionRoles</code> property.
   * @enum {String}
   * @readonly
   */
  exports.TransactionRolesEnum = {
    /**
     * value: "None"
     * @const
     */
