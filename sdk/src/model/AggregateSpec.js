...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.LusidSdk.AggregateSpec = factory(root.LusidSdk.ApiClient);
  }
  ...
  /**
   * The AggregateSpec model module.
   * @module model/AggregateSpec
   * @version 0.9.189
   */

  /**
   * Constructs a new <code>AggregateSpec</code>.
   * @alias module:model/AggregateSpec
   * @class
   */
  ...
  /**
   * Constructs a <code>AggregateSpec</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AggregateSpec} obj Optional instance to populate.
   * @return {module:model/AggregateSpec} The populated <code>AggregateSpec</code> instance.
   */
  ...
  /**
   * @member {module:model/AggregateSpec.OpEnum} op
   */
