...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.LusidSdk.TransactionQueryParameters = factory(root.LusidSdk.ApiClient);
  }
  ...
  /**
   * The TransactionQueryParameters model module.
   * @module model/TransactionQueryParameters
   * @version 0.9.189
   */

  /**
   * Constructs a new <code>TransactionQueryParameters</code>.
   * @alias module:model/TransactionQueryParameters
   * @class
   */
  ...
  /**
   * Constructs a <code>TransactionQueryParameters</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/TransactionQueryParameters} obj Optional instance to populate.
   * @return {module:model/TransactionQueryParameters} The populated <code>TransactionQueryParameters</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('showCancelledTransactions')) {
        obj['showCancelledTransactions'] = ApiClient.convertToType(data['showCancelledTransactions'], 'Boolean');
      }
    }
    return obj;
  }
   ...
   * @member {module:model/TransactionQueryParameters.QueryModeEnum} queryMode
   */
  exports.prototype['queryMode'] = undefined;
  /**
   * Option to include cancelled transactions in the results
   * @member {Boolean} showCancelledTransactions
   */
  exports.prototype['showCancelledTransactions'] = undefined;
