...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.LusidSdk.PortfolioProperties = factory(root.LusidSdk.ApiClient, root.LusidSdk.Link, root.LusidSdk.Property, root.LusidSdk.ResourceId, root.LusidSdk.Version);
  }
  ...
  /**
   * The PortfolioProperties model module.
   * @module model/PortfolioProperties
   * @version 0.9.189
   */

  /**
   * Constructs a new <code>PortfolioProperties</code>.
   * @alias module:model/PortfolioProperties
   * @class
   */
  ...
  /**
   * Constructs a <code>PortfolioProperties</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PortfolioProperties} obj Optional instance to populate.
   * @return {module:model/PortfolioProperties} The populated <code>PortfolioProperties</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('originPortfolioId')) {
        obj['originPortfolioId'] = ResourceId.constructFromObject(data['originPortfolioId']);
      }
  ...
  /**
   * @member {module:model/ResourceId} originPortfolioId
   */
  exports.prototype['originPortfolioId'] = undefined;
  /**
