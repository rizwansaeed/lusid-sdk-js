...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.LusidSdk.TargetTaxLotRequest = factory(root.LusidSdk.ApiClient, root.LusidSdk.CurrencyAndAmount);
  }
  ...
  /**
   * The TargetTaxLotRequest model module.
   * @module model/TargetTaxLotRequest
   * @version 0.9.189
   */

  /**
   * Constructs a new <code>TargetTaxLotRequest</code>.
   * @alias module:model/TargetTaxLotRequest
   * @class
   * @param units {Number} Quantity of holding
   */
  var exports = function(units) {
    var _this = this;
  ...
  /**
   * Constructs a <code>TargetTaxLotRequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/TargetTaxLotRequest} obj Optional instance to populate.
   * @return {module:model/TargetTaxLotRequest} The populated <code>TargetTaxLotRequest</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('portfolioCost')) {
        obj['portfolioCost'] = ApiClient.convertToType(data['portfolioCost'], 'Number');
      }
   ...
   * @member {Number} portfolioCost
   */
  exports.prototype['portfolioCost'] = undefined;
  /**
   ...
   */
  exports.prototype['purchaseDate'] = undefined;
  /**
