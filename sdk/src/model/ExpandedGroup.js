...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CompletePortfolio', 'model/ExpandedGroup', 'model/Link', 'model/ResourceId', 'model/Version'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./CompletePortfolio'), require('./ExpandedGroup'), require('./Link'), require('./ResourceId'), require('./Version'));
  } else {
    // Browser globals (root is window)
    if (!root.LusidSdk) {
      root.LusidSdk = {};
    }
    root.LusidSdk.ExpandedGroup = factory(root.LusidSdk.ApiClient, root.LusidSdk.CompletePortfolio, root.LusidSdk.ExpandedGroup, root.LusidSdk.Link, root.LusidSdk.ResourceId, root.LusidSdk.Version);
  }
}(this, function(ApiClient, CompletePortfolio, ExpandedGroup, Link, ResourceId, Version) {
  'use strict';
  ...
  /**
   * The ExpandedGroup model module.
   * @module model/ExpandedGroup
   * @version 0.9.189
   */

  /**
   * Constructs a new <code>ExpandedGroup</code>.
   * @alias module:model/ExpandedGroup
   * @class
   */
  ...
  /**
   * Constructs a <code>ExpandedGroup</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ExpandedGroup} obj Optional instance to populate.
   * @return {module:model/ExpandedGroup} The populated <code>ExpandedGroup</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('values')) {
        obj['values'] = ApiClient.convertToType(data['values'], [CompletePortfolio]);
      }
      if (data.hasOwnProperty('subGroups')) {
        obj['subGroups'] = ApiClient.convertToType(data['subGroups'], [ExpandedGroup]);
      }
  ...
  /**
   * @member {Array.<module:model/CompletePortfolio>} values
   */
  exports.prototype['values'] = undefined;
  /**
   * @member {Array.<module:model/ExpandedGroup>} subGroups
   */
