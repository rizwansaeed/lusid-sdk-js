...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/InstrumentEconomicDefinition', 'model/InstrumentProperty', 'model/ResourceId'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./InstrumentEconomicDefinition'), require('./InstrumentProperty'), require('./ResourceId'));
  } else {
    // Browser globals (root is window)
    if (!root.LusidSdk) {
      root.LusidSdk = {};
    }
    root.LusidSdk.InstrumentDefinition = factory(root.LusidSdk.ApiClient, root.LusidSdk.InstrumentEconomicDefinition, root.LusidSdk.InstrumentProperty, root.LusidSdk.ResourceId);
  }
}(this, function(ApiClient, InstrumentEconomicDefinition, InstrumentProperty, ResourceId) {
  'use strict';
  ...
  /**
   * The InstrumentDefinition model module.
   * @module model/InstrumentDefinition
   * @version 0.9.189
   */

  /**
   * Constructs a new <code>InstrumentDefinition</code>.
   * @alias module:model/InstrumentDefinition
   * @class
   * @param name {String} Required. The name of the instrument
   * @param identifiers {Object.<String, String>} Required. A set of identifiers that uniquely identify this instrument (e.g FIGI, RIC)
   */
  var exports = function(name, identifiers) {
    var _this = this;
  ...
  /**
   * Constructs a <code>InstrumentDefinition</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InstrumentDefinition} obj Optional instance to populate.
   * @return {module:model/InstrumentDefinition} The populated <code>InstrumentDefinition</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('properties')) {
        obj['properties'] = ApiClient.convertToType(data['properties'], [InstrumentProperty]);
      }
      if (data.hasOwnProperty('lookThroughPortfolioId')) {
        obj['lookThroughPortfolioId'] = ResourceId.constructFromObject(data['lookThroughPortfolioId']);
      }
      if (data.hasOwnProperty('definition')) {
        obj['definition'] = InstrumentEconomicDefinition.constructFromObject(data['definition']);
      }
    }
    return obj;
  }
   ...
   * @member {Array.<module:model/InstrumentProperty>} properties
   */
  exports.prototype['properties'] = undefined;
  /**
   * Optional. The identifier of the portfolio that represents this instrument
   * @member {module:model/ResourceId} lookThroughPortfolioId
   */
  exports.prototype['lookThroughPortfolioId'] = undefined;
  /**
   ...
   * @member {module:model/InstrumentEconomicDefinition} definition
   */
