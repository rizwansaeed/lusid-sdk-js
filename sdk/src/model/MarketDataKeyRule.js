...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.LusidSdk.MarketDataKeyRule = factory(root.LusidSdk.ApiClient);
  }
  ...
  /**
   * The MarketDataKeyRule model module.
   * @module model/MarketDataKeyRule
   * @version 0.9.189
   */

  /**
   * Constructs a new <code>MarketDataKeyRule</code>.
   * @alias module:model/MarketDataKeyRule
   * @class
   * @param key {String} The market data key pattern which this is a rule for. A dot separated string (A.B.C.D.*)
   * @param supplier {module:model/MarketDataKeyRule.SupplierEnum} the market data supplier (where the data comes from)
   * @param dataScope {String} the scope in which the data should be found when using this rule.
   */
  var exports = function(key, supplier, dataScope) {
    var _this = this;

    _this['key'] = key;
    _this['supplier'] = supplier;
    _this['dataScope'] = dataScope;


  };

  /**
   * Constructs a <code>MarketDataKeyRule</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/MarketDataKeyRule} obj Optional instance to populate.
   * @return {module:model/MarketDataKeyRule} The populated <code>MarketDataKeyRule</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('dataScope')) {
        obj['dataScope'] = ApiClient.convertToType(data['dataScope'], 'String');
      }
   ...
   * @member {module:model/MarketDataKeyRule.SupplierEnum} supplier
   */
  exports.prototype['supplier'] = undefined;
  /**
   * the scope in which the data should be found when using this rule.
   * @member {String} dataScope
   */
  exports.prototype['dataScope'] = undefined;
  /**
   * is the quote to be looked for a price, yield etc.
   * @member {module:model/MarketDataKeyRule.QuoteTypeEnum} quoteType
   */
  exports.prototype['quoteType'] = undefined;
  /**
   * the conceptual qualification for the field. Something like Bid, Ask or Mid.
   * @member {module:model/MarketDataKeyRule.PriceSideEnum} priceSide
   */
  exports.prototype['priceSide'] = undefined;


  /**
   * Allowed values for the <code>supplier</code> property.
   * @enum {String}
   * @readonly
   */
  exports.SupplierEnum = {
    /**
     * value: "DataScope"
     * @const
     */
