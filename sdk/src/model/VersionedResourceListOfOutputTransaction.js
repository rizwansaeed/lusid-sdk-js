...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Link', 'model/OutputTransaction', 'model/Version'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Link'), require('./OutputTransaction'), require('./Version'));
  } else {
    // Browser globals (root is window)
    if (!root.LusidSdk) {
      root.LusidSdk = {};
    }
    root.LusidSdk.VersionedResourceListOfOutputTransaction = factory(root.LusidSdk.ApiClient, root.LusidSdk.Link, root.LusidSdk.OutputTransaction, root.LusidSdk.Version);
  }
}(this, function(ApiClient, Link, OutputTransaction, Version) {
  'use strict';
  ...
  /**
   * The VersionedResourceListOfOutputTransaction model module.
   * @module model/VersionedResourceListOfOutputTransaction
   * @version 0.9.189
   */

  /**
   * Constructs a new <code>VersionedResourceListOfOutputTransaction</code>.
   * @alias module:model/VersionedResourceListOfOutputTransaction
   * @class
   */
  ...
  /**
   * Constructs a <code>VersionedResourceListOfOutputTransaction</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/VersionedResourceListOfOutputTransaction} obj Optional instance to populate.
   * @return {module:model/VersionedResourceListOfOutputTransaction} The populated <code>VersionedResourceListOfOutputTransaction</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('values')) {
        obj['values'] = ApiClient.convertToType(data['values'], [OutputTransaction]);
      }
  ...
  /**
   * @member {Array.<module:model/OutputTransaction>} values
   */
