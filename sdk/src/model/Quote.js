...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.LusidSdk.Quote = factory(root.LusidSdk.ApiClient, root.LusidSdk.MetricValue, root.LusidSdk.QuoteId, root.LusidSdk.QuoteLineage);
  }
   ...
   */
  var exports = function(quoteId, metricValue, quoteLineage) {
    var _this = this;
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('effectiveAtDate')) {
        obj['effectiveAtDate'] = ApiClient.convertToType(data['effectiveAtDate'], 'Date');
      }
      if (data.hasOwnProperty('asAtDate')) {
        obj['asAtDate'] = ApiClient.convertToType(data['asAtDate'], 'Date');
      }
    }
    return obj;
  }
  ...
  /**
   * @member {Date} effectiveAtDate
   */
  exports.prototype['effectiveAtDate'] = undefined;
  /**
   * @member {Date} asAtDate
   */
  exports.prototype['asAtDate'] = undefined;
