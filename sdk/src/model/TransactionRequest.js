...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CurrencyAndAmount', 'model/PerpetualPropertyValue', 'model/TransactionPrice'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./CurrencyAndAmount'), require('./PerpetualPropertyValue'), require('./TransactionPrice'));
  } else {
    // Browser globals (root is window)
    if (!root.LusidSdk) {
      root.LusidSdk = {};
    }
    root.LusidSdk.TransactionRequest = factory(root.LusidSdk.ApiClient, root.LusidSdk.CurrencyAndAmount, root.LusidSdk.PerpetualPropertyValue, root.LusidSdk.TransactionPrice);
  }
}(this, function(ApiClient, CurrencyAndAmount, PerpetualPropertyValue, TransactionPrice) {
  'use strict';
   ...
   * @param instrumentIdentifiers {Object.<String, String>} Unique instrument identifiers.
   ...
   * @param transactionPrice {module:model/TransactionPrice} Execution price for the transaction
   * @param totalConsideration {module:model/CurrencyAndAmount} Total value of the transaction, in settlement currency
   */
  var exports = function(transactionId, type, instrumentIdentifiers, transactionDate, settlementDate, units, transactionPrice, totalConsideration) {
    var _this = this;

    _this['transactionId'] = transactionId;
    _this['type'] = type;
    _this['instrumentIdentifiers'] = instrumentIdentifiers;
