...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/AggregateSpec', 'model/AggregationResponseNode'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./AggregateSpec'), require('./AggregationResponseNode'));
  } else {
    // Browser globals (root is window)
    if (!root.LusidSdk) {
      root.LusidSdk = {};
    }
    root.LusidSdk.AggregationResponseNode = factory(root.LusidSdk.ApiClient, root.LusidSdk.AggregateSpec, root.LusidSdk.AggregationResponseNode);
  }
}(this, function(ApiClient, AggregateSpec, AggregationResponseNode) {
  'use strict';
  ...
  /**
   * The AggregationResponseNode model module.
   * @module model/AggregationResponseNode
   * @version 0.9.189
   */

  /**
   * Constructs a new <code>AggregationResponseNode</code>.
   * @alias module:model/AggregationResponseNode
   * @class
   */
  ...
  /**
   * Constructs a <code>AggregationResponseNode</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AggregationResponseNode} obj Optional instance to populate.
   * @return {module:model/AggregationResponseNode} The populated <code>AggregationResponseNode</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('key')) {
        obj['key'] = AggregateSpec.constructFromObject(data['key']);
      }
      ...
      if (data.hasOwnProperty('children')) {
        obj['children'] = ApiClient.convertToType(data['children'], [AggregationResponseNode]);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {module:model/AggregateSpec} key
   */
  ...
  /**
   * @member {Array.<module:model/AggregationResponseNode>} children
   */
