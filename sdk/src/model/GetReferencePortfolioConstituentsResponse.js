...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Link', 'model/ReferencePortfolioConstituent'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Link'), require('./ReferencePortfolioConstituent'));
  } else {
    // Browser globals (root is window)
    if (!root.LusidSdk) {
      root.LusidSdk = {};
    }
    root.LusidSdk.GetReferencePortfolioConstituentsResponse = factory(root.LusidSdk.ApiClient, root.LusidSdk.Link, root.LusidSdk.ReferencePortfolioConstituent);
  }
}(this, function(ApiClient, Link, ReferencePortfolioConstituent) {
  'use strict';
  ...
  /**
   * The GetReferencePortfolioConstituentsResponse model module.
   * @module model/GetReferencePortfolioConstituentsResponse
   * @version 0.9.189
   */

  /**
   * Constructs a new <code>GetReferencePortfolioConstituentsResponse</code>.
   * @alias module:model/GetReferencePortfolioConstituentsResponse
   * @class
   * @param effectiveFrom {Date} 
   * @param weightType {module:model/GetReferencePortfolioConstituentsResponse.WeightTypeEnum} 
   * @param constituents {Array.<module:model/ReferencePortfolioConstituent>} Set of constituents (instrument/weight pairings)
   */
  ...
  /**
   * Constructs a <code>GetReferencePortfolioConstituentsResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GetReferencePortfolioConstituentsResponse} obj Optional instance to populate.
   * @return {module:model/GetReferencePortfolioConstituentsResponse} The populated <code>GetReferencePortfolioConstituentsResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('constituents')) {
        obj['constituents'] = ApiClient.convertToType(data['constituents'], [ReferencePortfolioConstituent]);
      }
  ...
  /**
   * 
   * @member {module:model/GetReferencePortfolioConstituentsResponse.WeightTypeEnum} weightType
   */
  exports.prototype['weightType'] = undefined;
  /**
   * 
   * @member {module:model/GetReferencePortfolioConstituentsResponse.PeriodTypeEnum} periodType
   */
   ...
   * @member {Array.<module:model/ReferencePortfolioConstituent>} constituents
   */
