...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CurrencyAndAmount', 'model/PerpetualProperty', 'model/RealisedGainLoss', 'model/TransactionPrice'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./CurrencyAndAmount'), require('./PerpetualProperty'), require('./RealisedGainLoss'), require('./TransactionPrice'));
  } else {
    // Browser globals (root is window)
    if (!root.LusidSdk) {
      root.LusidSdk = {};
    }
    root.LusidSdk.OutputTransaction = factory(root.LusidSdk.ApiClient, root.LusidSdk.CurrencyAndAmount, root.LusidSdk.PerpetualProperty, root.LusidSdk.RealisedGainLoss, root.LusidSdk.TransactionPrice);
  }
}(this, function(ApiClient, CurrencyAndAmount, PerpetualProperty, RealisedGainLoss, TransactionPrice) {
  'use strict';
  ...
  /**
   * The OutputTransaction model module.
   * @module model/OutputTransaction
   * @version 0.9.189
   */

  /**
   * Constructs a new <code>OutputTransaction</code>.
   * @alias module:model/OutputTransaction
   * @class
   */
  ...
  /**
   * Constructs a <code>OutputTransaction</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/OutputTransaction} obj Optional instance to populate.
   * @return {module:model/OutputTransaction} The populated <code>OutputTransaction</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('transactionToPortfolioRate')) {
        obj['transactionToPortfolioRate'] = ApiClient.convertToType(data['transactionToPortfolioRate'], 'Number');
      }
      ...
      if (data.hasOwnProperty('entryDateTime')) {
        obj['entryDateTime'] = ApiClient.convertToType(data['entryDateTime'], 'Date');
      }
      if (data.hasOwnProperty('cancelDateTime')) {
        obj['cancelDateTime'] = ApiClient.convertToType(data['cancelDateTime'], 'Date');
      }
      if (data.hasOwnProperty('realisedGainLoss')) {
        obj['realisedGainLoss'] = ApiClient.convertToType(data['realisedGainLoss'], [RealisedGainLoss]);
      }
    }
    return obj;
  }
   ...
   * @member {Number} transactionToPortfolioRate
   */
  exports.prototype['transactionToPortfolioRate'] = undefined;
  /**
   ...
   * @member {module:model/OutputTransaction.TransactionStatusEnum} transactionStatus
   */
  exports.prototype['transactionStatus'] = undefined;
  /**
   * Date/Time the transaction was booked into LUSID
   * @member {Date} entryDateTime
   */
  exports.prototype['entryDateTime'] = undefined;
  /**
   * Date/Time the cancellation was booked into LUSID
   * @member {Date} cancelDateTime
   */
  exports.prototype['cancelDateTime'] = undefined;
  /**
   * Collection of gains or losses
   * @member {Array.<module:model/RealisedGainLoss>} realisedGainLoss
   */
  exports.prototype['realisedGainLoss'] = undefined;
