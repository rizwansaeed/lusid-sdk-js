...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/IUnitDefinitionDto', 'model/Link', 'model/ResourceId'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./IUnitDefinitionDto'), require('./Link'), require('./ResourceId'));
  } else {
    // Browser globals (root is window)
    if (!root.LusidSdk) {
      root.LusidSdk = {};
    }
    root.LusidSdk.DataType = factory(root.LusidSdk.ApiClient, root.LusidSdk.IUnitDefinitionDto, root.LusidSdk.Link, root.LusidSdk.ResourceId);
  }
}(this, function(ApiClient, IUnitDefinitionDto, Link, ResourceId) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('acceptableUnits')) {
        obj['acceptableUnits'] = ApiClient.convertToType(data['acceptableUnits'], [IUnitDefinitionDto]);
      }
  ...
  /**
   * @member {module:model/DataType.TypeValueRangeEnum} typeValueRange
   */
  ...
  /**
   * @member {module:model/DataType.ValueTypeEnum} valueType
   */
  ...
  /**
   * @member {module:model/DataType.UnitSchemaEnum} unitSchema
   */
  exports.prototype['unitSchema'] = undefined;
  /**
   * @member {Array.<module:model/IUnitDefinitionDto>} acceptableUnits
   */
