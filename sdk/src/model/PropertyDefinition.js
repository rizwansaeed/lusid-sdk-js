...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Link', 'model/ResourceId'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Link'), require('./ResourceId'));
  } else {
    // Browser globals (root is window)
    if (!root.LusidSdk) {
      root.LusidSdk = {};
    }
    root.LusidSdk.PropertyDefinition = factory(root.LusidSdk.ApiClient, root.LusidSdk.Link, root.LusidSdk.ResourceId);
  }
}(this, function(ApiClient, Link, ResourceId) {
  'use strict';
  ...
  /**
   * @member {module:model/PropertyDefinition.ValueTypeEnum} valueType
   */
  ...
  /**
   * @member {module:model/PropertyDefinition.LifeTimeEnum} lifeTime
   */
  exports.prototype['lifeTime'] = undefined;
  /**
   * @member {module:model/PropertyDefinition.TypeEnum} type
   */
  exports.prototype['type'] = undefined;
  /**
   * @member {module:model/PropertyDefinition.UnitSchemaEnum} unitSchema
   */
  exports.prototype['unitSchema'] = undefined;
  /**
   * @member {module:model/PropertyDefinition.DomainEnum} domain
   */
