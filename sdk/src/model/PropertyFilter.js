...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.LusidSdk.PropertyFilter = factory(root.LusidSdk.ApiClient);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('rightOperandType')) {
        obj['rightOperandType'] = ApiClient.convertToType(data['rightOperandType'], 'String');
      }
    }
    return obj;
  }
  ...
  /**
   * @member {module:model/PropertyFilter.OperatorEnum} operator
   */
  ...
  /**
   * @member {module:model/PropertyFilter.RightOperandTypeEnum} rightOperandType
   */
  exports.prototype['rightOperandType'] = undefined;
  ...
  /**
   * Allowed values for the <code>rightOperandType</code> property.
   * @enum {String}
   * @readonly
   */
  exports.RightOperandTypeEnum = {
    /**
     * value: "Absolute"
     * @const
     */
