...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/AggregationResponseNode', 'model/Link', 'model/ResultDataSchema'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./AggregationResponseNode'), require('./Link'), require('./ResultDataSchema'));
  } else {
    // Browser globals (root is window)
    if (!root.LusidSdk) {
      root.LusidSdk = {};
    }
    root.LusidSdk.NestedAggregationResponse = factory(root.LusidSdk.ApiClient, root.LusidSdk.AggregationResponseNode, root.LusidSdk.Link, root.LusidSdk.ResultDataSchema);
  }
}(this, function(ApiClient, AggregationResponseNode, Link, ResultDataSchema) {
  'use strict';
  ...
  /**
   * The NestedAggregationResponse model module.
   * @module model/NestedAggregationResponse
   * @version 0.9.189
   */

  /**
   * Constructs a new <code>NestedAggregationResponse</code>.
   * @alias module:model/NestedAggregationResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>NestedAggregationResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/NestedAggregationResponse} obj Optional instance to populate.
   * @return {module:model/NestedAggregationResponse} The populated <code>NestedAggregationResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('data')) {
        obj['data'] = AggregationResponseNode.constructFromObject(data['data']);
      }
      if (data.hasOwnProperty('aggregationCurrency')) {
        obj['aggregationCurrency'] = ApiClient.convertToType(data['aggregationCurrency'], 'String');
      }
      if (data.hasOwnProperty('dataSchema')) {
        obj['dataSchema'] = ResultDataSchema.constructFromObject(data['dataSchema']);
      }
  ...
  /**
   * @member {module:model/AggregationResponseNode} data
   */
  exports.prototype['data'] = undefined;
  /**
   * @member {String} aggregationCurrency
   */
  exports.prototype['aggregationCurrency'] = undefined;
  /**
   * @member {module:model/ResultDataSchema} dataSchema
   */
  exports.prototype['dataSchema'] = undefined;
  /**
