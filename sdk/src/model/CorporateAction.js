...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CorporateActionTransition', 'model/ResourceId'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./CorporateActionTransition'), require('./ResourceId'));
  } else {
    // Browser globals (root is window)
    if (!root.LusidSdk) {
      root.LusidSdk = {};
    }
    root.LusidSdk.CorporateAction = factory(root.LusidSdk.ApiClient, root.LusidSdk.CorporateActionTransition, root.LusidSdk.ResourceId);
  }
}(this, function(ApiClient, CorporateActionTransition, ResourceId) {
  'use strict';
   ...
   * @class
   * @param sourceId {module:model/ResourceId} 
   * @param corporateActionCode {String} 
   */
  var exports = function(sourceId, corporateActionCode) {
    var _this = this;
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('sourceId')) {
        obj['sourceId'] = ResourceId.constructFromObject(data['sourceId']);
      }
      ...
      if (data.hasOwnProperty('transitions')) {
        obj['transitions'] = ApiClient.convertToType(data['transitions'], [CorporateActionTransition]);
      }
    }
    return obj;
  }
  ...
  /**
   * 
   * @member {module:model/ResourceId} sourceId
   */
  ...
  /**
   * @member {Array.<module:model/CorporateActionTransition>} transitions
   */
