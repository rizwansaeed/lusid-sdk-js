...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/PerpetualProperty', 'model/TargetTaxLot'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./PerpetualProperty'), require('./TargetTaxLot'));
  } else {
    // Browser globals (root is window)
    if (!root.LusidSdk) {
      root.LusidSdk = {};
    }
    root.LusidSdk.HoldingAdjustment = factory(root.LusidSdk.ApiClient, root.LusidSdk.PerpetualProperty, root.LusidSdk.TargetTaxLot);
  }
}(this, function(ApiClient, PerpetualProperty, TargetTaxLot) {
  'use strict';
  ...
  /**
   * The HoldingAdjustment model module.
   * @module model/HoldingAdjustment
   * @version 0.9.189
   */

  /**
   * Constructs a new <code>HoldingAdjustment</code>.
   ...
   * @alias module:model/HoldingAdjustment
   * @class
   * @param instrumentUid {String} Unique instrument identifier
   * @param taxLots {Array.<module:model/TargetTaxLot>} 1 or more quantity amounts
   */
  var exports = function(instrumentUid, taxLots) {
    var _this = this;
    ...
    _this['taxLots'] = taxLots;
  };

  /**
   * Constructs a <code>HoldingAdjustment</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/HoldingAdjustment} obj Optional instance to populate.
   * @return {module:model/HoldingAdjustment} The populated <code>HoldingAdjustment</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('taxLots')) {
        obj['taxLots'] = ApiClient.convertToType(data['taxLots'], [TargetTaxLot]);
      }
    }
    return obj;
  }
   ...
   * @member {Array.<module:model/TargetTaxLot>} taxLots
   */
  exports.prototype['taxLots'] = undefined;
