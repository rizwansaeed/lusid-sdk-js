...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ResourceId'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ResourceId'));
  } else {
    // Browser globals (root is window)
    if (!root.LusidSdk) {
      root.LusidSdk = {};
    }
    root.LusidSdk.CreateDerivedTransactionPortfolioRequest = factory(root.LusidSdk.ApiClient, root.LusidSdk.ResourceId);
  }
}(this, function(ApiClient, ResourceId) {
  'use strict';
  ...
  /**
   * The CreateDerivedTransactionPortfolioRequest model module.
   * @module model/CreateDerivedTransactionPortfolioRequest
   * @version 0.9.189
   */

  /**
   * Constructs a new <code>CreateDerivedTransactionPortfolioRequest</code>.
   * @alias module:model/CreateDerivedTransactionPortfolioRequest
   * @class
   * @param displayName {String} 
   */
  var exports = function(displayName) {
    var _this = this;
  ...
  /**
   * Constructs a <code>CreateDerivedTransactionPortfolioRequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CreateDerivedTransactionPortfolioRequest} obj Optional instance to populate.
   * @return {module:model/CreateDerivedTransactionPortfolioRequest} The populated <code>CreateDerivedTransactionPortfolioRequest</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('parentPortfolioId')) {
        obj['parentPortfolioId'] = ResourceId.constructFromObject(data['parentPortfolioId']);
      }
      if (data.hasOwnProperty('created')) {
        obj['created'] = ApiClient.convertToType(data['created'], 'Date');
      }
      if (data.hasOwnProperty('corporateActionSourceId')) {
        obj['corporateActionSourceId'] = ResourceId.constructFromObject(data['corporateActionSourceId']);
      }
      if (data.hasOwnProperty('accountingMethod')) {
        obj['accountingMethod'] = ApiClient.convertToType(data['accountingMethod'], 'String');
      }
      if (data.hasOwnProperty('subHoldingKeys')) {
        obj['subHoldingKeys'] = ApiClient.convertToType(data['subHoldingKeys'], ['String']);
      }
    }
    return obj;
  }
  ...
  /**
   * 
   * @member {module:model/ResourceId} parentPortfolioId
   */
  exports.prototype['parentPortfolioId'] = undefined;
  /**
   * 
   * @member {Date} created
   */
  ...
  /**
   * 
   * @member {module:model/ResourceId} corporateActionSourceId
   */
  exports.prototype['corporateActionSourceId'] = undefined;
  /**
   * 
   * @member {module:model/CreateDerivedTransactionPortfolioRequest.AccountingMethodEnum} accountingMethod
   */
  exports.prototype['accountingMethod'] = undefined;
  /**
   * 
   * @member {Array.<String>} subHoldingKeys
   */
