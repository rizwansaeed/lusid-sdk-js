...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Link', 'model/Property', 'model/ResourceId'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Link'), require('./Property'), require('./ResourceId'));
  } else {
    // Browser globals (root is window)
    if (!root.LusidSdk) {
      root.LusidSdk = {};
    }
    root.LusidSdk.PortfolioSearchResult = factory(root.LusidSdk.ApiClient, root.LusidSdk.Link, root.LusidSdk.Property, root.LusidSdk.ResourceId);
  }
}(this, function(ApiClient, Link, Property, ResourceId) {
  'use strict';
  ...
  /**
   * The PortfolioSearchResult model module.
   * @module model/PortfolioSearchResult
   * @version 0.9.189
   */

  /**
   * Constructs a new <code>PortfolioSearchResult</code>.
   * @alias module:model/PortfolioSearchResult
   * @class
   */
  ...
  /**
   * Constructs a <code>PortfolioSearchResult</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PortfolioSearchResult} obj Optional instance to populate.
   * @return {module:model/PortfolioSearchResult} The populated <code>PortfolioSearchResult</code> instance.
   */
  ...
  /**
   * @member {module:model/PortfolioSearchResult.TypeEnum} type
   */
