...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.LusidSdk.TransactionPrice = factory(root.LusidSdk.ApiClient);
  }
  ...
  /**
   * The TransactionPrice model module.
   * @module model/TransactionPrice
   * @version 0.9.189
   */

  /**
   * Constructs a new <code>TransactionPrice</code>.
   * A price with its associated type
   * @alias module:model/TransactionPrice
   * @class
   */
  ...
  /**
   * Constructs a <code>TransactionPrice</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/TransactionPrice} obj Optional instance to populate.
   * @return {module:model/TransactionPrice} The populated <code>TransactionPrice</code> instance.
   */
  ...
  /**
   * @member {module:model/TransactionPrice.TypeEnum} type
   */
