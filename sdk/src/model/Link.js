...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.LusidSdk.Link = factory(root.LusidSdk.ApiClient);
  }
   ...
   * @class
   * @param relation {module:model/Link.RelationEnum} 
   * @param href {String} 
   * @param method {module:model/Link.MethodEnum} 
   */
  var exports = function(relation, href, method) {
    var _this = this;
  ...
  /**
   * @member {module:model/Link.RelationEnum} relation
   */
  ...
  /**
   * @member {module:model/Link.MethodEnum} method
   */
