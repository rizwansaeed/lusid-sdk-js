...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.LusidSdk.UpdatePropertyDefinitionRequest = factory(root.LusidSdk.ApiClient, root.LusidSdk.ResourceId);
  }
  ...
  /**
   * The UpdatePropertyDefinitionRequest model module.
   * @module model/UpdatePropertyDefinitionRequest
   * @version 0.9.189
   */

  /**
   * Constructs a new <code>UpdatePropertyDefinitionRequest</code>.
   * @alias module:model/UpdatePropertyDefinitionRequest
   * @class
   */
  ...
  /**
   * Constructs a <code>UpdatePropertyDefinitionRequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/UpdatePropertyDefinitionRequest} obj Optional instance to populate.
   * @return {module:model/UpdatePropertyDefinitionRequest} The populated <code>UpdatePropertyDefinitionRequest</code> instance.
   */
  ...
  /**
   * @member {module:model/UpdatePropertyDefinitionRequest.LifeTimeEnum} lifeTime
   */
  exports.prototype['lifeTime'] = undefined;
  /**
   * @member {module:model/UpdatePropertyDefinitionRequest.TypeEnum} type
   */
