...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CurrencyAndAmount', 'model/PerpetualProperty', 'model/Property'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./CurrencyAndAmount'), require('./PerpetualProperty'), require('./Property'));
  } else {
    // Browser globals (root is window)
    if (!root.LusidSdk) {
      root.LusidSdk = {};
    }
    root.LusidSdk.ReconciliationBreak = factory(root.LusidSdk.ApiClient, root.LusidSdk.CurrencyAndAmount, root.LusidSdk.PerpetualProperty, root.LusidSdk.Property);
  }
}(this, function(ApiClient, CurrencyAndAmount, PerpetualProperty, Property) {
  'use strict';
  ...
  /**
   * The ReconciliationBreak model module.
   * @module model/ReconciliationBreak
   * @version 0.9.189
   */

  /**
   * Constructs a new <code>ReconciliationBreak</code>.
   * A reconciliation break
   * @alias module:model/ReconciliationBreak
   * @class
   * @param instrumentUid {String} Unique instrument identifier
   * @param subHoldingKeys {Array.<module:model/PerpetualProperty>} Any other properties that comprise the Sub-Holding Key
   * @param leftUnits {Number} Units from the left hand side
   * @param rightUnits {Number} Units from the right hand side
   * @param differenceUnits {Number} Difference in units
   * @param leftCost {module:model/CurrencyAndAmount} Cost from the left hand side
   * @param rightCost {module:model/CurrencyAndAmount} Cost from the right hand side
   * @param differenceCost {module:model/CurrencyAndAmount} Difference in cost
   * @param instrumentProperties {Array.<module:model/Property>} Additional features relating to the security
   */
  var exports = function(instrumentUid, subHoldingKeys, leftUnits, rightUnits, differenceUnits, leftCost, rightCost, differenceCost, instrumentProperties) {
    var _this = this;

    _this['instrumentUid'] = instrumentUid;
    _this['subHoldingKeys'] = subHoldingKeys;
    _this['leftUnits'] = leftUnits;
    _this['rightUnits'] = rightUnits;
    _this['differenceUnits'] = differenceUnits;
    _this['leftCost'] = leftCost;
    _this['rightCost'] = rightCost;
    _this['differenceCost'] = differenceCost;
    _this['instrumentProperties'] = instrumentProperties;
  };

  /**
   * Constructs a <code>ReconciliationBreak</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ReconciliationBreak} obj Optional instance to populate.
   * @return {module:model/ReconciliationBreak} The populated <code>ReconciliationBreak</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('leftUnits')) {
        obj['leftUnits'] = ApiClient.convertToType(data['leftUnits'], 'Number');
      }
      if (data.hasOwnProperty('rightUnits')) {
        obj['rightUnits'] = ApiClient.convertToType(data['rightUnits'], 'Number');
      }
      if (data.hasOwnProperty('differenceUnits')) {
        obj['differenceUnits'] = ApiClient.convertToType(data['differenceUnits'], 'Number');
      }
      if (data.hasOwnProperty('leftCost')) {
        obj['leftCost'] = CurrencyAndAmount.constructFromObject(data['leftCost']);
      }
      if (data.hasOwnProperty('rightCost')) {
        obj['rightCost'] = CurrencyAndAmount.constructFromObject(data['rightCost']);
      }
      if (data.hasOwnProperty('differenceCost')) {
        obj['differenceCost'] = CurrencyAndAmount.constructFromObject(data['differenceCost']);
      }
      if (data.hasOwnProperty('instrumentProperties')) {
        obj['instrumentProperties'] = ApiClient.convertToType(data['instrumentProperties'], [Property]);
      }
    }
    return obj;
  }
   ...
   * @member {Number} leftUnits
   */
  exports.prototype['leftUnits'] = undefined;
  /**
   * Units from the right hand side
   * @member {Number} rightUnits
   */
  exports.prototype['rightUnits'] = undefined;
  /**
   * Difference in units
   * @member {Number} differenceUnits
   */
  exports.prototype['differenceUnits'] = undefined;
  /**
   * Cost from the left hand side
   * @member {module:model/CurrencyAndAmount} leftCost
   */
  exports.prototype['leftCost'] = undefined;
  /**
   * Cost from the right hand side
   * @member {module:model/CurrencyAndAmount} rightCost
   */
  exports.prototype['rightCost'] = undefined;
  /**
   * Difference in cost
   * @member {module:model/CurrencyAndAmount} differenceCost
   */
  exports.prototype['differenceCost'] = undefined;
  /**
   * Additional features relating to the security
   * @member {Array.<module:model/Property>} instrumentProperties
   */
  exports.prototype['instrumentProperties'] = undefined;
