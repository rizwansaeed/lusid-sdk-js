...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Link', 'model/ResultDataSchema'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Link'), require('./ResultDataSchema'));
  } else {
    // Browser globals (root is window)
    if (!root.LusidSdk) {
      root.LusidSdk = {};
    }
    root.LusidSdk.ListAggregationResponse = factory(root.LusidSdk.ApiClient, root.LusidSdk.Link, root.LusidSdk.ResultDataSchema);
  }
}(this, function(ApiClient, Link, ResultDataSchema) {
  'use strict';
  ...
  /**
   * The ListAggregationResponse model module.
   * @module model/ListAggregationResponse
   * @version 0.9.189
   */

  /**
   * Constructs a new <code>ListAggregationResponse</code>.
   * @alias module:model/ListAggregationResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>ListAggregationResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ListAggregationResponse} obj Optional instance to populate.
   * @return {module:model/ListAggregationResponse} The populated <code>ListAggregationResponse</code> instance.
   */
