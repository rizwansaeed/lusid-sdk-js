...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Link', 'model/Property', 'model/ResourceId', 'model/Version'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Link'), require('./Property'), require('./ResourceId'), require('./Version'));
  } else {
    // Browser globals (root is window)
    if (!root.LusidSdk) {
      root.LusidSdk = {};
    }
    root.LusidSdk.CompletePortfolio = factory(root.LusidSdk.ApiClient, root.LusidSdk.Link, root.LusidSdk.Property, root.LusidSdk.ResourceId, root.LusidSdk.Version);
  }
}(this, function(ApiClient, Link, Property, ResourceId, Version) {
  'use strict';
  ...
  /**
   * The CompletePortfolio model module.
   * @module model/CompletePortfolio
   * @version 0.9.189
   */

  /**
   * Constructs a new <code>CompletePortfolio</code>.
   * @alias module:model/CompletePortfolio
   * @class
   */
  ...
  /**
   * Constructs a <code>CompletePortfolio</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CompletePortfolio} obj Optional instance to populate.
   * @return {module:model/CompletePortfolio} The populated <code>CompletePortfolio</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('isDerived')) {
        obj['isDerived'] = ApiClient.convertToType(data['isDerived'], 'Boolean');
      }
   ...
   */
  exports.prototype['isDerived'] = undefined;
  /**
   * @member {module:model/CompletePortfolio.TypeEnum} type
   */
