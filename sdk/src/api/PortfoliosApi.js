...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
     ...
     * @param {String} code The code of the portfolio
     * @param {Object} opts Optional parameters
     * @param {module:model/UpdatePortfolioRequest} opts.request The updated portfolio definition
     ...
     * @param {String} code The code of the portfolio
     * @param {Object} opts Optional parameters
     * @param {Object} opts.portfolioProperties The property values to be upserted to the portfolio
    ...
    this.upsertPortfolioPropertiesWithHttpInfo = function(scope, code, opts) {
      opts = opts || {};
      var postBody = opts['portfolioProperties'];
