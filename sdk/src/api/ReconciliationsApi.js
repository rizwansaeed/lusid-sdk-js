...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ErrorResponse', 'model/PortfoliosReconciliationRequest', 'model/ResourceListOfReconciliationBreak', 'model/ValuationsReconciliationRequest'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/ErrorResponse'), require('../model/PortfoliosReconciliationRequest'), require('../model/ResourceListOfReconciliationBreak'), require('../model/ValuationsReconciliationRequest'));
  } else {
    // Browser globals (root is window)
    if (!root.LusidSdk) {
      root.LusidSdk = {};
    }
    root.LusidSdk.ReconciliationsApi = factory(root.LusidSdk.ApiClient, root.LusidSdk.ErrorResponse, root.LusidSdk.PortfoliosReconciliationRequest, root.LusidSdk.ResourceListOfReconciliationBreak, root.LusidSdk.ValuationsReconciliationRequest);
  }
}(this, function(ApiClient, ErrorResponse, PortfoliosReconciliationRequest, ResourceListOfReconciliationBreak, ValuationsReconciliationRequest) {
  'use strict';

  /**
   * Reconciliations service.
   * @module api/ReconciliationsApi
   * @version 0.9.189
   */

  /**
   * Constructs a new ReconciliationsApi. 
   * @alias module:api/ReconciliationsApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @param {module:model/PortfoliosReconciliationRequest} opts.request The specifications of the inputs to the reconciliation
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ResourceListOfReconciliationBreak} and HTTP response
     */
    this.reconcileHoldingsWithHttpInfo = function(opts) {
      opts = opts || {};
      ...
      var returnType = ResourceListOfReconciliationBreak;
     ...
     * @param {Number} opts.limit Optional. When paginating, limit the number of returned results to this many.
     * @param {String} opts.filter Optional. Expression to filter the result set
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ResourceListOfReconciliationBreak}
     */
    this.reconcileHoldings = function(opts) {
      return this.reconcileHoldingsWithHttpInfo(opts)
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/ValuationsReconciliationRequest} opts.request The specifications of the inputs to the reconciliation
     * @param {Array.<String>} opts.sortBy Optional. Order the results by these fields. Use use the &#39;-&#39; sign to denote descending order e.g. -MyFieldName
     * @param {Number} opts.start Optional. When paginating, skip this number of results
     * @param {Number} opts.limit Optional. When paginating, limit the number of returned results to this many.
     * @param {String} opts.filter Optional. Expression to filter the result set
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ResourceListOfReconciliationBreak} and HTTP response
     */
    this.reconcileValuationWithHttpInfo = function(opts) {
      opts = opts || {};
      var postBody = opts['request'];
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ResourceListOfReconciliationBreak}
     */
    this.reconcileValuation = function(opts) {
      return this.reconcileValuationWithHttpInfo(opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
