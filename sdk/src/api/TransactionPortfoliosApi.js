...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
     ...
     * @param {Object} opts.transactionProperties Transaction properties values
    ...
    this.addTransactionPropertyWithHttpInfo = function(scope, code, transactionId, opts) {
      opts = opts || {};
      var postBody = opts['transactionProperties'];
     ...
     * @param {Object} opts Optional parameters
     * @param {Array.<module:model/AdjustHoldingRequest>} opts.holdingAdjustments The selected set of holdings adjustments
    ...
    this.adjustHoldingsWithHttpInfo = function(scope, code, effectiveAt, opts) {
      opts = opts || {};
      var postBody = opts['holdingAdjustments'];
     ...
     * @param {module:model/TransactionQueryParameters} opts.parameters Optional. Transaction query parameters
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/CreateTransactionPortfolioRequest} opts.createRequest The transaction portfolio definition
    ...
    this.createPortfolioWithHttpInfo = function(scope, opts) {
      opts = opts || {};
      var postBody = opts['createRequest'];
     ...
     * @param {Date} effectiveAt The effective date of the change
     * @param {Object} opts Optional parameters
     * @param {Array.<module:model/AdjustHoldingRequest>} opts.holdingAdjustments The complete set of holdings adjustments for the portfolio
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/AdjustHolding} and HTTP response
     */
     ...
     * @param {String} code The code of the portfolio
     * @param {Object} opts Optional parameters
     * @param {Array.<module:model/ExecutionRequest>} opts.executions The executions to be updated
     ...
     * @param {String} code The code of the portfolio
     * @param {Object} opts Optional parameters
     * @param {module:model/CreatePortfolioDetails} opts.details The set of details for the portfolio
     ...
     * @param {Object} opts Optional parameters
     * @param {Array.<module:model/TransactionRequest>} opts.transactions The transactions to be upserted
