...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ErrorResponse', 'model/FileResponse', 'model/VersionSummaryDto'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/ErrorResponse'), require('../model/FileResponse'), require('../model/VersionSummaryDto'));
  } else {
    // Browser globals (root is window)
    if (!root.LusidSdk) {
      root.LusidSdk = {};
    }
    root.LusidSdk.ApplicationMetadataApi = factory(root.LusidSdk.ApiClient, root.LusidSdk.ErrorResponse, root.LusidSdk.FileResponse, root.LusidSdk.VersionSummaryDto);
  }
}(this, function(ApiClient, ErrorResponse, FileResponse, VersionSummaryDto) {
  'use strict';

  /**
   * ApplicationMetadata service.
   * @module api/ApplicationMetadataApi
   * @version 0.9.189
   */

  /**
   * Constructs a new ApplicationMetadataApi. 
   * @alias module:api/ApplicationMetadataApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @param {String} opts.version The requested version of the Excel plugin
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/FileResponse} and HTTP response
     */
    this.getExcelAddinWithHttpInfo = function(opts) {
      opts = opts || {};
      var postBody = null;
     ...
     * @param {Object} opts Optional parameters
     * @param {String} opts.version The requested version of the Excel plugin
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/FileResponse}
     */
    this.getExcelAddin = function(opts) {
      return this.getExcelAddinWithHttpInfo(opts)
     ...
     */
    this.getExcelDownloadUrlWithHttpInfo = function(opts) {
      opts = opts || {};
      var postBody = null;
      ...
      return this.apiClient.callApi(
        '/api/metadata/downloads/excel', 'GET',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType
      );
    }
     ...
     */
    this.getExcelDownloadUrl = function(opts) {
      return this.getExcelDownloadUrlWithHttpInfo(opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/VersionSummaryDto} and HTTP response
     */
    this.getLusidVersionsWithHttpInfo = function() {
      var postBody = null;
      ...
      var contentTypes = [];
      var accepts = ['text/plain', 'application/json', 'text/json'];
      var returnType = VersionSummaryDto;
     ...
     * Get LUSID versions
     * Get the semantic versions associated with LUSID and its ecosystem
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/VersionSummaryDto}
     */
    this.getLusidVersions = function() {
      return this.getLusidVersionsWithHttpInfo()
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
