...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ErrorResponse', 'model/PropertySchema', 'model/ResourceListOfString', 'model/ResourceListOfValueType', 'model/Schema'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/ErrorResponse'), require('../model/PropertySchema'), require('../model/ResourceListOfString'), require('../model/ResourceListOfValueType'), require('../model/Schema'));
  } else {
    // Browser globals (root is window)
    if (!root.LusidSdk) {
      root.LusidSdk = {};
    }
    root.LusidSdk.SchemasApi = factory(root.LusidSdk.ApiClient, root.LusidSdk.ErrorResponse, root.LusidSdk.PropertySchema, root.LusidSdk.ResourceListOfString, root.LusidSdk.ResourceListOfValueType, root.LusidSdk.Schema);
  }
}(this, function(ApiClient, ErrorResponse, PropertySchema, ResourceListOfString, ResourceListOfValueType, Schema) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     */
    this.getEntitySchemaWithHttpInfo = function(entity) {
      var postBody = null;

      // verify the required parameter 'entity' is set
      if (entity === undefined || entity === null) {
        throw new Error("Missing the required parameter 'entity' when calling getEntitySchema");
      }
    ...
    this.getEntitySchema = function(entity) {
      return this.getEntitySchemaWithHttpInfo(entity)
     ...
     * @param {Array.<String>} opts.propertyKeys One or more property keys for which the schema is requested
     * @param {Date} opts.asAt Optional. The AsAt date of the data
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/PropertySchema} and HTTP response
     */
    this.getPropertySchemaWithHttpInfo = function(opts) {
      opts = opts || {};
      var postBody = null;
     ...
     * @param {Array.<String>} opts.propertyKeys One or more property keys for which the schema is requested
     * @param {Date} opts.asAt Optional. The AsAt date of the data
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/PropertySchema}
     */
    this.getPropertySchema = function(opts) {
      return this.getPropertySchemaWithHttpInfo(opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ResourceListOfValueType} and HTTP response
     */
    this.getValueTypesWithHttpInfo = function(opts) {
      opts = opts || {};
      var postBody = null;
      ...
      var contentTypes = [];
      var accepts = ['text/plain', 'application/json', 'text/json'];
      var returnType = ResourceListOfValueType;
     ...
     * @param {Number} opts.start Optional. When paginating, skip this number of results
     * @param {Number} opts.limit Optional. When paginating, limit the number of returned results to this many.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ResourceListOfValueType}
     */
    this.getValueTypes = function(opts) {
      return this.getValueTypesWithHttpInfo(opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     */
    this.listEntitiesWithHttpInfo = function() {
      var postBody = null;
     ...
     */
    this.listEntities = function() {
      return this.listEntitiesWithHttpInfo()
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
