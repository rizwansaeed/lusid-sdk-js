...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CreateResults', 'model/ErrorResponse', 'model/Results'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/CreateResults'), require('../model/ErrorResponse'), require('../model/Results'));
  } else {
    // Browser globals (root is window)
    if (!root.LusidSdk) {
      root.LusidSdk = {};
    }
    root.LusidSdk.ResultsApi = factory(root.LusidSdk.ApiClient, root.LusidSdk.CreateResults, root.LusidSdk.ErrorResponse, root.LusidSdk.Results);
  }
}(this, function(ApiClient, CreateResults, ErrorResponse, Results) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @param {Date} _date The date for which the data was loaded
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/Results} and HTTP response
     */
    this.getResultsWithHttpInfo = function(scope, key, _date, opts) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'scope' is set
      if (scope === undefined || scope === null) {
        throw new Error("Missing the required parameter 'scope' when calling getResults");
      }

      // verify the required parameter 'key' is set
      if (key === undefined || key === null) {
        throw new Error("Missing the required parameter 'key' when calling getResults");
      }

      // verify the required parameter '_date' is set
      if (_date === undefined || _date === null) {
        throw new Error("Missing the required parameter '_date' when calling getResults");
      }
      ...
      var returnType = Results;

      return this.apiClient.callApi(
        '/api/results/{scope}/{key}/{date}', 'GET',
     ...
     * @param {Number} opts.start Optional. When paginating, skip this number of results
     * @param {Number} opts.limit Optional. When paginating, limit the number of returned results to this many.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/Results}
     */
    this.getResults = function(scope, key, _date, opts) {
      return this.getResultsWithHttpInfo(scope, key, _date, opts)
     ...
     * @param {String} scope The scope of the data
     * @param {String} key The key that identifies the data
     * @param {Date} _date The date for which the data is relevant
     * @param {Object} opts Optional parameters
     * @param {module:model/CreateResults} opts.request The results to upload
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/Results} and HTTP response
     */
    this.upsertResultsWithHttpInfo = function(scope, key, _date, opts) {
      opts = opts || {};
      var postBody = opts['request'];

      // verify the required parameter 'scope' is set
      if (scope === undefined || scope === null) {
        throw new Error("Missing the required parameter 'scope' when calling upsertResults");
      }

      // verify the required parameter 'key' is set
      if (key === undefined || key === null) {
        throw new Error("Missing the required parameter 'key' when calling upsertResults");
      }

      // verify the required parameter '_date' is set
      if (_date === undefined || _date === null) {
        throw new Error("Missing the required parameter '_date' when calling upsertResults");
      }
      ...
      return this.apiClient.callApi(
        '/api/results/{scope}/{key}/{date}', 'POST',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType
      );
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/Results}
     */
    this.upsertResults = function(scope, key, _date, opts) {
      return this.upsertResultsWithHttpInfo(scope, key, _date, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
