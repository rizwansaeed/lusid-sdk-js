...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
     ...
     * @param {Array.<module:model/Property>} opts.aliases The list of market aliases (e.g ISIN, Ticker) to find instruments by.
     ...
     * @param {Array.<module:model/String>} opts.identifiers The identifiers of the instruments to get
     ...
     * @param {String} identifier The instrument identifier
     * @param {Object} opts Optional parameters
     * @param {module:model/UpdateInstrumentIdentifierRequest} opts.request The identifier to add, update, or remove
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/Instrument} and HTTP response
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {Object} opts.requests The instrument definitions
     ...
     * @param {Object} opts Optional parameters
     * @param {Array.<module:model/UpsertInstrumentPropertyRequest>} opts.instrumentProperties The instrument property data
    ...
    this.upsertInstrumentsPropertiesWithHttpInfo = function(opts) {
      opts = opts || {};
      var postBody = opts['instrumentProperties'];
