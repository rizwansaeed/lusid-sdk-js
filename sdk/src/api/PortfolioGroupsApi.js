...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CreatePortfolioGroupRequest', 'model/DeletedEntityResponse', 'model/ErrorResponse', 'model/ExpandedGroup', 'model/PortfolioGroup', 'model/ResourceId', 'model/ResourceListOfPortfolioGroup', 'model/ResourceListOfProcessedCommand', 'model/UpdatePortfolioGroupRequest'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/CreatePortfolioGroupRequest'), require('../model/DeletedEntityResponse'), require('../model/ErrorResponse'), require('../model/ExpandedGroup'), require('../model/PortfolioGroup'), require('../model/ResourceId'), require('../model/ResourceListOfPortfolioGroup'), require('../model/ResourceListOfProcessedCommand'), require('../model/UpdatePortfolioGroupRequest'));
  } else {
    // Browser globals (root is window)
    if (!root.LusidSdk) {
      root.LusidSdk = {};
    }
    root.LusidSdk.PortfolioGroupsApi = factory(root.LusidSdk.ApiClient, root.LusidSdk.CreatePortfolioGroupRequest, root.LusidSdk.DeletedEntityResponse, root.LusidSdk.ErrorResponse, root.LusidSdk.ExpandedGroup, root.LusidSdk.PortfolioGroup, root.LusidSdk.ResourceId, root.LusidSdk.ResourceListOfPortfolioGroup, root.LusidSdk.ResourceListOfProcessedCommand, root.LusidSdk.UpdatePortfolioGroupRequest);
  }
}(this, function(ApiClient, CreatePortfolioGroupRequest, DeletedEntityResponse, ErrorResponse, ExpandedGroup, PortfolioGroup, ResourceId, ResourceListOfPortfolioGroup, ResourceListOfProcessedCommand, UpdatePortfolioGroupRequest) {
  'use strict';

  /**
   * PortfolioGroups service.
   * @module api/PortfolioGroupsApi
   * @version 0.9.189
   */

  /**
   * Constructs a new PortfolioGroupsApi. 
   * @alias module:api/PortfolioGroupsApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @param {String} scope The scope of the portfolio group to which a portfolio is being added
     * @param {String} code The code of the portfolio group to which a portfolio is being added
     * @param {Object} opts Optional parameters
     * @param {module:model/ResourceId} opts.portfolioId The id of the portfolio
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/PortfolioGroup} and HTTP response
     */
    this.addPortfolioToGroupWithHttpInfo = function(scope, code, opts) {
      opts = opts || {};
      var postBody = opts['portfolioId'];

      // verify the required parameter 'scope' is set
      if (scope === undefined || scope === null) {
        throw new Error("Missing the required parameter 'scope' when calling addPortfolioToGroup");
      }

      // verify the required parameter 'code' is set
      if (code === undefined || code === null) {
        throw new Error("Missing the required parameter 'code' when calling addPortfolioToGroup");
      }
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/ResourceId} opts.portfolioId The id of the portfolio
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/PortfolioGroup}
     */
    this.addPortfolioToGroup = function(scope, code, opts) {
      return this.addPortfolioToGroupWithHttpInfo(scope, code, opts)
     ...
     * @param {String} scope The scope of the portfolio group to which a sub-group is being added
     * @param {String} code The code of the portfolio group to which a sub-group is being added
     * @param {Object} opts Optional parameters
     * @param {module:model/ResourceId} opts.portfolioGroupId The id of the portfolio group being added as a sub-group
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/PortfolioGroup} and HTTP response
     */
    this.addSubGroupToGroupWithHttpInfo = function(scope, code, opts) {
      opts = opts || {};
      var postBody = opts['portfolioGroupId'];

      // verify the required parameter 'scope' is set
      if (scope === undefined || scope === null) {
        throw new Error("Missing the required parameter 'scope' when calling addSubGroupToGroup");
      }

      // verify the required parameter 'code' is set
      if (code === undefined || code === null) {
        throw new Error("Missing the required parameter 'code' when calling addSubGroupToGroup");
      }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/PortfolioGroup}
     */
    this.addSubGroupToGroup = function(scope, code, opts) {
      return this.addSubGroupToGroupWithHttpInfo(scope, code, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @param {String} scope The scope into which the portfolio group will be created
     * @param {Object} opts Optional parameters
     * @param {module:model/CreatePortfolioGroupRequest} opts.request The definition of the new portfolio group
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/PortfolioGroup} and HTTP response
     */
    this.createPortfolioGroupWithHttpInfo = function(scope, opts) {
      opts = opts || {};
      var postBody = opts['request'];

      // verify the required parameter 'scope' is set
      if (scope === undefined || scope === null) {
        throw new Error("Missing the required parameter 'scope' when calling createPortfolioGroup");
      }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/PortfolioGroup}
     */
    this.createPortfolioGroup = function(scope, opts) {
      return this.createPortfolioGroupWithHttpInfo(scope, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/PortfolioGroup} and HTTP response
     */
    this.deletePortfolioFromGroupWithHttpInfo = function(scope, code, portfolioScope, portfolioCode) {
      var postBody = null;

      // verify the required parameter 'scope' is set
      if (scope === undefined || scope === null) {
        throw new Error("Missing the required parameter 'scope' when calling deletePortfolioFromGroup");
      }

      // verify the required parameter 'code' is set
      if (code === undefined || code === null) {
        throw new Error("Missing the required parameter 'code' when calling deletePortfolioFromGroup");
      }

      // verify the required parameter 'portfolioScope' is set
      if (portfolioScope === undefined || portfolioScope === null) {
        throw new Error("Missing the required parameter 'portfolioScope' when calling deletePortfolioFromGroup");
      }

      // verify the required parameter 'portfolioCode' is set
      if (portfolioCode === undefined || portfolioCode === null) {
        throw new Error("Missing the required parameter 'portfolioCode' when calling deletePortfolioFromGroup");
      }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/PortfolioGroup}
     */
    this.deletePortfolioFromGroup = function(scope, code, portfolioScope, portfolioCode) {
      return this.deletePortfolioFromGroupWithHttpInfo(scope, code, portfolioScope, portfolioCode)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     */
    this.deletePortfolioGroupWithHttpInfo = function(scope, code) {
      var postBody = null;

      // verify the required parameter 'scope' is set
      if (scope === undefined || scope === null) {
        throw new Error("Missing the required parameter 'scope' when calling deletePortfolioGroup");
      }

      // verify the required parameter 'code' is set
      if (code === undefined || code === null) {
        throw new Error("Missing the required parameter 'code' when calling deletePortfolioGroup");
      }
     ...
     */
    this.deletePortfolioGroup = function(scope, code) {
      return this.deletePortfolioGroupWithHttpInfo(scope, code)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/PortfolioGroup} and HTTP response
     */
    this.deleteSubGroupFromGroupWithHttpInfo = function(scope, code, subgroupScope, subgroupCode) {
      var postBody = null;

      // verify the required parameter 'scope' is set
      if (scope === undefined || scope === null) {
        throw new Error("Missing the required parameter 'scope' when calling deleteSubGroupFromGroup");
      }

      // verify the required parameter 'code' is set
      if (code === undefined || code === null) {
        throw new Error("Missing the required parameter 'code' when calling deleteSubGroupFromGroup");
      }

      // verify the required parameter 'subgroupScope' is set
      if (subgroupScope === undefined || subgroupScope === null) {
        throw new Error("Missing the required parameter 'subgroupScope' when calling deleteSubGroupFromGroup");
      }

      // verify the required parameter 'subgroupCode' is set
      if (subgroupCode === undefined || subgroupCode === null) {
        throw new Error("Missing the required parameter 'subgroupCode' when calling deleteSubGroupFromGroup");
      }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/PortfolioGroup}
     */
    this.deleteSubGroupFromGroup = function(scope, code, subgroupScope, subgroupCode) {
      return this.deleteSubGroupFromGroupWithHttpInfo(scope, code, subgroupScope, subgroupCode)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/PortfolioGroup} and HTTP response
     */
    this.getPortfolioGroupWithHttpInfo = function(scope, code, opts) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'scope' is set
      if (scope === undefined || scope === null) {
        throw new Error("Missing the required parameter 'scope' when calling getPortfolioGroup");
      }

      // verify the required parameter 'code' is set
      if (code === undefined || code === null) {
        throw new Error("Missing the required parameter 'code' when calling getPortfolioGroup");
      }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/PortfolioGroup}
     */
    this.getPortfolioGroup = function(scope, code, opts) {
      return this.getPortfolioGroupWithHttpInfo(scope, code, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     */
    this.getPortfolioGroupCommandsWithHttpInfo = function(scope, code, opts) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'scope' is set
      if (scope === undefined || scope === null) {
        throw new Error("Missing the required parameter 'scope' when calling getPortfolioGroupCommands");
      }

      // verify the required parameter 'code' is set
      if (code === undefined || code === null) {
        throw new Error("Missing the required parameter 'code' when calling getPortfolioGroupCommands");
      }
     ...
     */
    this.getPortfolioGroupCommands = function(scope, code, opts) {
      return this.getPortfolioGroupCommandsWithHttpInfo(scope, code, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @param {Date} opts.asAt Optional. The AsAt date of the data
     * @param {Array.<String>} opts.propertyFilter Optional. The restricted set of properties that should be returned
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ExpandedGroup} and HTTP response
     */
    this.getPortfolioGroupExpansionWithHttpInfo = function(scope, code, opts) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'scope' is set
      if (scope === undefined || scope === null) {
        throw new Error("Missing the required parameter 'scope' when calling getPortfolioGroupExpansion");
      }

      // verify the required parameter 'code' is set
      if (code === undefined || code === null) {
        throw new Error("Missing the required parameter 'code' when calling getPortfolioGroupExpansion");
      }
     ...
     * @param {Date} opts.asAt Optional. The AsAt date of the data
     * @param {Array.<String>} opts.propertyFilter Optional. The restricted set of properties that should be returned
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ExpandedGroup}
     */
    this.getPortfolioGroupExpansion = function(scope, code, opts) {
      return this.getPortfolioGroupExpansionWithHttpInfo(scope, code, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     */
    this.listPortfolioGroupsWithHttpInfo = function(scope, opts) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'scope' is set
      if (scope === undefined || scope === null) {
        throw new Error("Missing the required parameter 'scope' when calling listPortfolioGroups");
      }
     ...
     */
    this.listPortfolioGroups = function(scope, opts) {
      return this.listPortfolioGroupsWithHttpInfo(scope, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @param {String} code The code of the portfolio group
     * @param {Object} opts Optional parameters
     * @param {module:model/UpdatePortfolioGroupRequest} opts.request The updated definition of the portfolio group
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/PortfolioGroup} and HTTP response
     */
    this.updatePortfolioGroupWithHttpInfo = function(scope, code, opts) {
      opts = opts || {};
      var postBody = opts['request'];

      // verify the required parameter 'scope' is set
      if (scope === undefined || scope === null) {
        throw new Error("Missing the required parameter 'scope' when calling updatePortfolioGroup");
      }

      // verify the required parameter 'code' is set
      if (code === undefined || code === null) {
        throw new Error("Missing the required parameter 'code' when calling updatePortfolioGroup");
      }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/PortfolioGroup}
     */
    this.updatePortfolioGroup = function(scope, code, opts) {
      return this.updatePortfolioGroupWithHttpInfo(scope, code, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
