...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ErrorResponse', 'model/ResourceListOfTransactionConfigurationData', 'model/TransactionConfigurationDataRequest'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/ErrorResponse'), require('../model/ResourceListOfTransactionConfigurationData'), require('../model/TransactionConfigurationDataRequest'));
  } else {
    // Browser globals (root is window)
    if (!root.LusidSdk) {
      root.LusidSdk = {};
    }
    root.LusidSdk.SystemConfigurationApi = factory(root.LusidSdk.ApiClient, root.LusidSdk.ErrorResponse, root.LusidSdk.ResourceListOfTransactionConfigurationData, root.LusidSdk.TransactionConfigurationDataRequest);
  }
}(this, function(ApiClient, ErrorResponse, ResourceListOfTransactionConfigurationData, TransactionConfigurationDataRequest) {
  'use strict';

  /**
   * SystemConfiguration service.
   * @module api/SystemConfigurationApi
   * @version 0.9.189
   */

  /**
   * Constructs a new SystemConfigurationApi. 
   * @alias module:api/SystemConfigurationApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @param {module:model/TransactionConfigurationDataRequest} opts.type A transaction type definition
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ResourceListOfTransactionConfigurationData} and HTTP response
     */
    this.createConfigurationTransactionTypeWithHttpInfo = function(opts) {
      opts = opts || {};
      ...
      var returnType = ResourceListOfTransactionConfigurationData;

      return this.apiClient.callApi(
        '/api/systemconfiguration/transactiontypes', 'POST',
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/TransactionConfigurationDataRequest} opts.type A transaction type definition
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ResourceListOfTransactionConfigurationData}
     */
    this.createConfigurationTransactionType = function(opts) {
      return this.createConfigurationTransactionTypeWithHttpInfo(opts)
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ResourceListOfTransactionConfigurationData} and HTTP response
     */
    this.listConfigurationTransactionTypesWithHttpInfo = function() {
      var postBody = null;
      ...
      return this.apiClient.callApi(
        '/api/systemconfiguration/transactiontypes', 'GET',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType
      );
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ResourceListOfTransactionConfigurationData}
     */
    this.listConfigurationTransactionTypes = function() {
      return this.listConfigurationTransactionTypesWithHttpInfo()
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @param {Object} opts Optional parameters
     * @param {Array.<module:model/TransactionConfigurationDataRequest>} opts.types The complete set of transaction type definitions
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ResourceListOfTransactionConfigurationData} and HTTP response
     */
    this.setConfigurationTransactionTypesWithHttpInfo = function(opts) {
      opts = opts || {};
      var postBody = opts['types'];
      ...
      return this.apiClient.callApi(
        '/api/systemconfiguration/transactiontypes', 'PUT',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType
      );
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ResourceListOfTransactionConfigurationData}
     */
    this.setConfigurationTransactionTypes = function(opts) {
      return this.setConfigurationTransactionTypesWithHttpInfo(opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
