...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CreateReferencePortfolioRequest', 'model/ErrorResponse', 'model/GetReferencePortfolioConstituentsResponse', 'model/Portfolio', 'model/ResourceListOfConstituentsAdjustmentHeader', 'model/UpsertReferencePortfolioConstituentsRequest', 'model/UpsertReferencePortfolioConstituentsResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/CreateReferencePortfolioRequest'), require('../model/ErrorResponse'), require('../model/GetReferencePortfolioConstituentsResponse'), require('../model/Portfolio'), require('../model/ResourceListOfConstituentsAdjustmentHeader'), require('../model/UpsertReferencePortfolioConstituentsRequest'), require('../model/UpsertReferencePortfolioConstituentsResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.LusidSdk) {
      root.LusidSdk = {};
    }
    root.LusidSdk.ReferencePortfolioApi = factory(root.LusidSdk.ApiClient, root.LusidSdk.CreateReferencePortfolioRequest, root.LusidSdk.ErrorResponse, root.LusidSdk.GetReferencePortfolioConstituentsResponse, root.LusidSdk.Portfolio, root.LusidSdk.ResourceListOfConstituentsAdjustmentHeader, root.LusidSdk.UpsertReferencePortfolioConstituentsRequest, root.LusidSdk.UpsertReferencePortfolioConstituentsResponse);
  }
}(this, function(ApiClient, CreateReferencePortfolioRequest, ErrorResponse, GetReferencePortfolioConstituentsResponse, Portfolio, ResourceListOfConstituentsAdjustmentHeader, UpsertReferencePortfolioConstituentsRequest, UpsertReferencePortfolioConstituentsResponse) {
  'use strict';

  /**
   * ReferencePortfolio service.
   * @module api/ReferencePortfolioApi
   * @version 0.9.189
   */

  /**
   * Constructs a new ReferencePortfolioApi. 
   * @alias module:api/ReferencePortfolioApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @param {module:model/CreateReferencePortfolioRequest} opts.referencePortfolio The portfolio creation request object
     ...
     */
    this.createReferencePortfolioWithHttpInfo = function(scope, opts) {
      opts = opts || {};
      var postBody = opts['referencePortfolio'];

      // verify the required parameter 'scope' is set
      if (scope === undefined || scope === null) {
        throw new Error("Missing the required parameter 'scope' when calling createReferencePortfolio");
      }
     ...
     */
    this.createReferencePortfolio = function(scope, opts) {
      return this.createReferencePortfolioWithHttpInfo(scope, opts)
     ...
     * @param {Object} opts Optional parameters
     * @param {Date} opts.effectiveAt Optional. The effective date of the constituents to retrieve
     * @param {Date} opts.asAt Optional. The AsAt date of the data
     * @param {Array.<String>} opts.sortBy Optional. Order the results by these fields. Use the &#39;-&#39; sign to denote descending order e.g. -MyFieldName
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/GetReferencePortfolioConstituentsResponse} and HTTP response
     */
    this.getReferencePortfolioConstituentsWithHttpInfo = function(scope, code, opts) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'scope' is set
      if (scope === undefined || scope === null) {
        throw new Error("Missing the required parameter 'scope' when calling getReferencePortfolioConstituents");
      }

      // verify the required parameter 'code' is set
      if (code === undefined || code === null) {
        throw new Error("Missing the required parameter 'code' when calling getReferencePortfolioConstituents");
      }
      ...
      var contentTypes = [];
      var accepts = ['text/plain', 'application/json', 'text/json'];
      var returnType = GetReferencePortfolioConstituentsResponse;
     ...
     * @param {Number} opts.start Optional. When paginating, skip this number of results
     * @param {Number} opts.limit Optional. When paginating, limit the number of returned results to this many
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/GetReferencePortfolioConstituentsResponse}
     */
    this.getReferencePortfolioConstituents = function(scope, code, opts) {
      return this.getReferencePortfolioConstituentsWithHttpInfo(scope, code, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @param {Object} opts Optional parameters
     * @param {Date} opts.fromEffectiveAt Events between this time (inclusive) and the toEffectiveAt are returned.
     * @param {Date} opts.toEffectiveAt Events between this time (inclusive) and the fromEffectiveAt are returned.
     * @param {Date} opts.asAtTime The as-at time for which the result is valid.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ResourceListOfConstituentsAdjustmentHeader} and HTTP response
     */
    this.listConstituentsAdjustmentsWithHttpInfo = function(scope, code, opts) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'scope' is set
      if (scope === undefined || scope === null) {
        throw new Error("Missing the required parameter 'scope' when calling listConstituentsAdjustments");
      }

      // verify the required parameter 'code' is set
      if (code === undefined || code === null) {
        throw new Error("Missing the required parameter 'code' when calling listConstituentsAdjustments");
      }
      ...
      var contentTypes = [];
      var accepts = ['text/plain', 'application/json', 'text/json'];
      var returnType = ResourceListOfConstituentsAdjustmentHeader;
     ...
     * @param {Date} opts.toEffectiveAt Events between this time (inclusive) and the fromEffectiveAt are returned.
     * @param {Date} opts.asAtTime The as-at time for which the result is valid.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ResourceListOfConstituentsAdjustmentHeader}
     */
    this.listConstituentsAdjustments = function(scope, code, opts) {
      return this.listConstituentsAdjustmentsWithHttpInfo(scope, code, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @param {String} code The code of the portfolio
     * @param {Object} opts Optional parameters
     * @param {module:model/UpsertReferencePortfolioConstituentsRequest} opts.constituents The constituents to upload to the portfolio
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/UpsertReferencePortfolioConstituentsResponse} and HTTP response
     */
    this.upsertReferencePortfolioConstituentsWithHttpInfo = function(scope, code, opts) {
      opts = opts || {};
      var postBody = opts['constituents'];

      // verify the required parameter 'scope' is set
      if (scope === undefined || scope === null) {
        throw new Error("Missing the required parameter 'scope' when calling upsertReferencePortfolioConstituents");
      }

      // verify the required parameter 'code' is set
      if (code === undefined || code === null) {
        throw new Error("Missing the required parameter 'code' when calling upsertReferencePortfolioConstituents");
      }
      ...
      var contentTypes = ['application/json-patch+json', 'application/json', 'text/json', 'application/_*+json'];
      var accepts = ['text/plain', 'application/json', 'text/json'];
      var returnType = UpsertReferencePortfolioConstituentsResponse;
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/UpsertReferencePortfolioConstituentsRequest} opts.constituents The constituents to upload to the portfolio
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/UpsertReferencePortfolioConstituentsResponse}
     */
    this.upsertReferencePortfolioConstituents = function(scope, code, opts) {
      return this.upsertReferencePortfolioConstituentsWithHttpInfo(scope, code, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
