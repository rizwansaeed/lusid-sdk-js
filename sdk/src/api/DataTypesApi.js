...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CreateDataTypeRequest', 'model/DataType', 'model/ErrorResponse', 'model/ResourceListOfDataType', 'model/ResourceListOfIUnitDefinitionDto', 'model/UpdateDataTypeRequest'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/CreateDataTypeRequest'), require('../model/DataType'), require('../model/ErrorResponse'), require('../model/ResourceListOfDataType'), require('../model/ResourceListOfIUnitDefinitionDto'), require('../model/UpdateDataTypeRequest'));
  } else {
    // Browser globals (root is window)
    if (!root.LusidSdk) {
      root.LusidSdk = {};
    }
    root.LusidSdk.DataTypesApi = factory(root.LusidSdk.ApiClient, root.LusidSdk.CreateDataTypeRequest, root.LusidSdk.DataType, root.LusidSdk.ErrorResponse, root.LusidSdk.ResourceListOfDataType, root.LusidSdk.ResourceListOfIUnitDefinitionDto, root.LusidSdk.UpdateDataTypeRequest);
  }
}(this, function(ApiClient, CreateDataTypeRequest, DataType, ErrorResponse, ResourceListOfDataType, ResourceListOfIUnitDefinitionDto, UpdateDataTypeRequest) {
  'use strict';

  /**
   * DataTypes service.
   * @module api/DataTypesApi
   * @version 0.9.189
   */

  /**
   * Constructs a new DataTypesApi. 
   * @alias module:api/DataTypesApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @param {module:model/CreateDataTypeRequest} opts.request The definition of the new data type
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/DataType} and HTTP response
     */
    this.createDataTypeWithHttpInfo = function(opts) {
      opts = opts || {};
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/CreateDataTypeRequest} opts.request The definition of the new data type
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/DataType}
     */
    this.createDataType = function(opts) {
      return this.createDataTypeWithHttpInfo(opts)
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/DataType} and HTTP response
     */
    this.getDataTypeWithHttpInfo = function(scope, code) {
      var postBody = null;

      // verify the required parameter 'scope' is set
      if (scope === undefined || scope === null) {
        throw new Error("Missing the required parameter 'scope' when calling getDataType");
      }

      // verify the required parameter 'code' is set
      if (code === undefined || code === null) {
        throw new Error("Missing the required parameter 'code' when calling getDataType");
      }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/DataType}
     */
    this.getDataType = function(scope, code) {
      return this.getDataTypeWithHttpInfo(scope, code)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @param {String} code The code of the data type
     * @param {Object} opts Optional parameters
     * @param {Array.<String>} opts.units One or more unit identifiers for which the definition is being requested
     * @param {String} opts.filter Optional. Expression to filter the result set
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ResourceListOfIUnitDefinitionDto} and HTTP response
     */
    this.getUnitsFromDataTypeWithHttpInfo = function(scope, code, opts) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'scope' is set
      if (scope === undefined || scope === null) {
        throw new Error("Missing the required parameter 'scope' when calling getUnitsFromDataType");
      }

      // verify the required parameter 'code' is set
      if (code === undefined || code === null) {
        throw new Error("Missing the required parameter 'code' when calling getUnitsFromDataType");
      }
      ...
      var contentTypes = [];
      var accepts = ['text/plain', 'application/json', 'text/json'];
      var returnType = ResourceListOfIUnitDefinitionDto;
     ...
     * @param {Array.<String>} opts.units One or more unit identifiers for which the definition is being requested
     * @param {String} opts.filter Optional. Expression to filter the result set
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ResourceListOfIUnitDefinitionDto}
     */
    this.getUnitsFromDataType = function(scope, code, opts) {
      return this.getUnitsFromDataTypeWithHttpInfo(scope, code, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @param {Object} opts Optional parameters
     * @param {Boolean} opts.includeDefault Whether to additionally include those data types in the \&quot;default\&quot; scope
     * @param {Boolean} opts.includeSystem Whether to additionally include those data types in the \&quot;system\&quot; scope
     ...
     * @param {String} opts.filter Optional. Expression to filter the result set
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ResourceListOfDataType} and HTTP response
     */
    this.listDataTypesWithHttpInfo = function(scope, opts) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'scope' is set
      if (scope === undefined || scope === null) {
        throw new Error("Missing the required parameter 'scope' when calling listDataTypes");
      }
      ...
      var contentTypes = [];
      var accepts = ['text/plain', 'application/json', 'text/json'];
      var returnType = ResourceListOfDataType;
     ...
     * @param {Number} opts.limit Optional. When paginating, limit the number of returned results to this many.
     * @param {String} opts.filter Optional. Expression to filter the result set
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ResourceListOfDataType}
     */
    this.listDataTypes = function(scope, opts) {
      return this.listDataTypesWithHttpInfo(scope, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @param {String} code The code of the data type
     * @param {Object} opts Optional parameters
     * @param {module:model/UpdateDataTypeRequest} opts.request The updated definition of the data type
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/DataType} and HTTP response
     */
    this.updateDataTypeWithHttpInfo = function(scope, code, opts) {
      opts = opts || {};
      var postBody = opts['request'];

      // verify the required parameter 'scope' is set
      if (scope === undefined || scope === null) {
        throw new Error("Missing the required parameter 'scope' when calling updateDataType");
      }

      // verify the required parameter 'code' is set
      if (code === undefined || code === null) {
        throw new Error("Missing the required parameter 'code' when calling updateDataType");
      }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/DataType}
     */
    this.updateDataType = function(scope, code, opts) {
      return this.updateDataTypeWithHttpInfo(scope, code, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
