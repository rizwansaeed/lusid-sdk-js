...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CreatePropertyDefinitionRequest', 'model/DeletedEntityResponse', 'model/ErrorResponse', 'model/PropertyDefinition', 'model/ResourceListOfPropertyDefinition', 'model/UpdatePropertyDefinitionRequest'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/CreatePropertyDefinitionRequest'), require('../model/DeletedEntityResponse'), require('../model/ErrorResponse'), require('../model/PropertyDefinition'), require('../model/ResourceListOfPropertyDefinition'), require('../model/UpdatePropertyDefinitionRequest'));
  } else {
    // Browser globals (root is window)
    if (!root.LusidSdk) {
      root.LusidSdk = {};
    }
    root.LusidSdk.PropertyDefinitionsApi = factory(root.LusidSdk.ApiClient, root.LusidSdk.CreatePropertyDefinitionRequest, root.LusidSdk.DeletedEntityResponse, root.LusidSdk.ErrorResponse, root.LusidSdk.PropertyDefinition, root.LusidSdk.ResourceListOfPropertyDefinition, root.LusidSdk.UpdatePropertyDefinitionRequest);
  }
}(this, function(ApiClient, CreatePropertyDefinitionRequest, DeletedEntityResponse, ErrorResponse, PropertyDefinition, ResourceListOfPropertyDefinition, UpdatePropertyDefinitionRequest) {
  'use strict';

  /**
   * PropertyDefinitions service.
   * @module api/PropertyDefinitionsApi
   * @version 0.9.189
   */

  /**
   * Constructs a new PropertyDefinitionsApi. 
   * @alias module:api/PropertyDefinitionsApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @param {module:model/CreatePropertyDefinitionRequest} opts.definition The definition of the new property
     ...
     */
    this.createPropertyDefinitionWithHttpInfo = function(opts) {
      opts = opts || {};
      var postBody = opts['definition'];
     ...
     */
    this.createPropertyDefinition = function(opts) {
      return this.createPropertyDefinitionWithHttpInfo(opts)
     ...
     * @param {module:model/String} domain The Property Domain of the property to be deleted
     ...
     */
    this.deletePropertyDefinitionWithHttpInfo = function(domain, scope, code) {
      var postBody = null;

      // verify the required parameter 'domain' is set
      if (domain === undefined || domain === null) {
        throw new Error("Missing the required parameter 'domain' when calling deletePropertyDefinition");
      }

      // verify the required parameter 'scope' is set
      if (scope === undefined || scope === null) {
        throw new Error("Missing the required parameter 'scope' when calling deletePropertyDefinition");
      }

      // verify the required parameter 'code' is set
      if (code === undefined || code === null) {
        throw new Error("Missing the required parameter 'code' when calling deletePropertyDefinition");
      }
     ...
     */
    this.deletePropertyDefinition = function(domain, scope, code) {
      return this.deletePropertyDefinitionWithHttpInfo(domain, scope, code)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @param {Object} opts Optional parameters
     * @param {Array.<String>} opts.propertyKeys One or more keys for properties for which the schema should be returned
     ...
     */
    this.getMultiplePropertyDefinitionsWithHttpInfo = function(opts) {
      opts = opts || {};
      var postBody = null;
     ...
     */
    this.getMultiplePropertyDefinitions = function(opts) {
      return this.getMultiplePropertyDefinitionsWithHttpInfo(opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @param {module:model/String} domain The Property Domain of the requested property
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/PropertyDefinition} and HTTP response
     */
    this.getPropertyDefinitionWithHttpInfo = function(domain, scope, code, opts) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'domain' is set
      if (domain === undefined || domain === null) {
        throw new Error("Missing the required parameter 'domain' when calling getPropertyDefinition");
      }

      // verify the required parameter 'scope' is set
      if (scope === undefined || scope === null) {
        throw new Error("Missing the required parameter 'scope' when calling getPropertyDefinition");
      }

      // verify the required parameter 'code' is set
      if (code === undefined || code === null) {
        throw new Error("Missing the required parameter 'code' when calling getPropertyDefinition");
      }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/PropertyDefinition}
     */
    this.getPropertyDefinition = function(domain, scope, code, opts) {
      return this.getPropertyDefinitionWithHttpInfo(domain, scope, code, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @param {module:model/String} domain The Property Domain of the property being updated
     * @param {String} scope The scope of the property to be updated
     * @param {String} code The code of the property to be updated
     * @param {Object} opts Optional parameters
     * @param {module:model/UpdatePropertyDefinitionRequest} opts.definition The updated definition of the property
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/PropertyDefinition} and HTTP response
     */
    this.updatePropertyDefinitionWithHttpInfo = function(domain, scope, code, opts) {
      opts = opts || {};
      var postBody = opts['definition'];

      // verify the required parameter 'domain' is set
      if (domain === undefined || domain === null) {
        throw new Error("Missing the required parameter 'domain' when calling updatePropertyDefinition");
      }

      // verify the required parameter 'scope' is set
      if (scope === undefined || scope === null) {
        throw new Error("Missing the required parameter 'scope' when calling updatePropertyDefinition");
      }

      // verify the required parameter 'code' is set
      if (code === undefined || code === null) {
        throw new Error("Missing the required parameter 'code' when calling updatePropertyDefinition");
      }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/PropertyDefinition}
     */
    this.updatePropertyDefinition = function(domain, scope, code, opts) {
      return this.updatePropertyDefinitionWithHttpInfo(domain, scope, code, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
