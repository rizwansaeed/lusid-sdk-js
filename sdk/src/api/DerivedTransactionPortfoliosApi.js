...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CreateDerivedTransactionPortfolioRequest', 'model/DeletedEntityResponse', 'model/ErrorResponse', 'model/Portfolio'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/CreateDerivedTransactionPortfolioRequest'), require('../model/DeletedEntityResponse'), require('../model/ErrorResponse'), require('../model/Portfolio'));
  } else {
    // Browser globals (root is window)
    if (!root.LusidSdk) {
      root.LusidSdk = {};
    }
    root.LusidSdk.DerivedTransactionPortfoliosApi = factory(root.LusidSdk.ApiClient, root.LusidSdk.CreateDerivedTransactionPortfolioRequest, root.LusidSdk.DeletedEntityResponse, root.LusidSdk.ErrorResponse, root.LusidSdk.Portfolio);
  }
}(this, function(ApiClient, CreateDerivedTransactionPortfolioRequest, DeletedEntityResponse, ErrorResponse, Portfolio) {
  'use strict';

  /**
   * DerivedTransactionPortfolios service.
   * @module api/DerivedTransactionPortfoliosApi
   * @version 0.9.189
   */

  /**
   * Constructs a new DerivedTransactionPortfoliosApi. 
   * @alias module:api/DerivedTransactionPortfoliosApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @param {String} scope The scope into which to create the new derived portfolio
     * @param {Object} opts Optional parameters
     * @param {module:model/CreateDerivedTransactionPortfolioRequest} opts.portfolio The root object of the new derived portfolio, containing a populated reference portfolio id and reference scope
     ...
     */
    this.createDerivedPortfolioWithHttpInfo = function(scope, opts) {
      opts = opts || {};
      var postBody = opts['portfolio'];

      // verify the required parameter 'scope' is set
      if (scope === undefined || scope === null) {
        throw new Error("Missing the required parameter 'scope' when calling createDerivedPortfolio");
      }
     ...
     */
    this.createDerivedPortfolio = function(scope, opts) {
      return this.createDerivedPortfolioWithHttpInfo(scope, opts)
     ...
     * @param {Object} opts Optional parameters
     * @param {Date} opts.effectiveAt The effective date of the change
     ...
     */
    this.deleteDerivedPortfolioDetailsWithHttpInfo = function(scope, code, opts) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'scope' is set
      if (scope === undefined || scope === null) {
        throw new Error("Missing the required parameter 'scope' when calling deleteDerivedPortfolioDetails");
      }

      // verify the required parameter 'code' is set
      if (code === undefined || code === null) {
        throw new Error("Missing the required parameter 'code' when calling deleteDerivedPortfolioDetails");
      }
     ...
     */
    this.deleteDerivedPortfolioDetails = function(scope, code, opts) {
      return this.deleteDerivedPortfolioDetailsWithHttpInfo(scope, code, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
