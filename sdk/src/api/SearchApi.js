...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
     ...
     * @param {Array.<module:model/InstrumentSearchProperty>} opts.symbols A collection of instrument symbols to search for
     ...
     * @param {Object} opts Optional parameters
     * @param {String} opts.request A valid Elasticsearch 5.x request
