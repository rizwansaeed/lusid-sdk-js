...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/AnalyticStore', 'model/CreateAnalyticStoreRequest', 'model/DeletedEntityResponse', 'model/ErrorResponse', 'model/InstrumentAnalytic', 'model/ResourceListOfAnalyticStoreKey'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/AnalyticStore'), require('../model/CreateAnalyticStoreRequest'), require('../model/DeletedEntityResponse'), require('../model/ErrorResponse'), require('../model/InstrumentAnalytic'), require('../model/ResourceListOfAnalyticStoreKey'));
  } else {
    // Browser globals (root is window)
    if (!root.LusidSdk) {
      root.LusidSdk = {};
    }
    root.LusidSdk.AnalyticsStoresApi = factory(root.LusidSdk.ApiClient, root.LusidSdk.AnalyticStore, root.LusidSdk.CreateAnalyticStoreRequest, root.LusidSdk.DeletedEntityResponse, root.LusidSdk.ErrorResponse, root.LusidSdk.InstrumentAnalytic, root.LusidSdk.ResourceListOfAnalyticStoreKey);
  }
}(this, function(ApiClient, AnalyticStore, CreateAnalyticStoreRequest, DeletedEntityResponse, ErrorResponse, InstrumentAnalytic, ResourceListOfAnalyticStoreKey) {
  'use strict';

  /**
   * AnalyticsStores service.
   * @module api/AnalyticsStoresApi
   * @version 0.9.189
   */

  /**
   * Constructs a new AnalyticsStoresApi. 
   * @alias module:api/AnalyticsStoresApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @param {module:model/CreateAnalyticStoreRequest} opts.request A populated analytic store definition
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/AnalyticStore} and HTTP response
     */
    this.createAnalyticStoreWithHttpInfo = function(opts) {
      opts = opts || {};
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/CreateAnalyticStoreRequest} opts.request A populated analytic store definition
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/AnalyticStore}
     */
    this.createAnalyticStore = function(opts) {
      return this.createAnalyticStoreWithHttpInfo(opts)
     ...
     */
    this.deleteAnalyticStoreWithHttpInfo = function(scope, year, month, day) {
      var postBody = null;

      // verify the required parameter 'scope' is set
      if (scope === undefined || scope === null) {
        throw new Error("Missing the required parameter 'scope' when calling deleteAnalyticStore");
      }

      // verify the required parameter 'year' is set
      if (year === undefined || year === null) {
        throw new Error("Missing the required parameter 'year' when calling deleteAnalyticStore");
      }

      // verify the required parameter 'month' is set
      if (month === undefined || month === null) {
        throw new Error("Missing the required parameter 'month' when calling deleteAnalyticStore");
      }

      // verify the required parameter 'day' is set
      if (day === undefined || day === null) {
        throw new Error("Missing the required parameter 'day' when calling deleteAnalyticStore");
      }
      ...
      return this.apiClient.callApi(
        '/api/analytics/{scope}/{year}/{month}/{day}', 'DELETE',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType
      );
    }
     ...
     */
    this.deleteAnalyticStore = function(scope, year, month, day) {
      return this.deleteAnalyticStoreWithHttpInfo(scope, year, month, day)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @param {String} scope The analytics data scope
     * @param {Number} year The year component of the date for the data in the scope
     * @param {Number} month The month component of the date for the data in the scope
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/AnalyticStore} and HTTP response
     */
    this.getAnalyticStoreWithHttpInfo = function(scope, year, month, day, opts) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'scope' is set
      if (scope === undefined || scope === null) {
        throw new Error("Missing the required parameter 'scope' when calling getAnalyticStore");
      }

      // verify the required parameter 'year' is set
      if (year === undefined || year === null) {
        throw new Error("Missing the required parameter 'year' when calling getAnalyticStore");
      }

      // verify the required parameter 'month' is set
      if (month === undefined || month === null) {
        throw new Error("Missing the required parameter 'month' when calling getAnalyticStore");
      }

      // verify the required parameter 'day' is set
      if (day === undefined || day === null) {
        throw new Error("Missing the required parameter 'day' when calling getAnalyticStore");
      }
      ...
      return this.apiClient.callApi(
        '/api/analytics/{scope}/{year}/{month}/{day}', 'GET',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType
      );
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/AnalyticStore}
     */
    this.getAnalyticStore = function(scope, year, month, day, opts) {
      return this.getAnalyticStoreWithHttpInfo(scope, year, month, day, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ResourceListOfAnalyticStoreKey} and HTTP response
     */
    this.listAnalyticStoresWithHttpInfo = function(opts) {
      opts = opts || {};
      var postBody = null;
      ...
      var contentTypes = [];
      var accepts = ['text/plain', 'application/json', 'text/json'];
      var returnType = ResourceListOfAnalyticStoreKey;
     ...
     * @param {Number} opts.limit Optional. When paginating, limit the number of returned results to this many.
     * @param {String} opts.filter Optional. Expression to filter the result set
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ResourceListOfAnalyticStoreKey}
     */
    this.listAnalyticStores = function(opts) {
      return this.listAnalyticStoresWithHttpInfo(opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @param {Object} opts Optional parameters
     * @param {Array.<module:model/InstrumentAnalytic>} opts.data The analytic data being inserted
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/AnalyticStore} and HTTP response
     */
    this.setAnalyticsWithHttpInfo = function(scope, year, month, day, opts) {
      opts = opts || {};
      var postBody = opts['data'];

      // verify the required parameter 'scope' is set
      if (scope === undefined || scope === null) {
        throw new Error("Missing the required parameter 'scope' when calling setAnalytics");
      }

      // verify the required parameter 'year' is set
      if (year === undefined || year === null) {
        throw new Error("Missing the required parameter 'year' when calling setAnalytics");
      }

      // verify the required parameter 'month' is set
      if (month === undefined || month === null) {
        throw new Error("Missing the required parameter 'month' when calling setAnalytics");
      }

      // verify the required parameter 'day' is set
      if (day === undefined || day === null) {
        throw new Error("Missing the required parameter 'day' when calling setAnalytics");
      }
      ...
      return this.apiClient.callApi(
        '/api/analytics/{scope}/{year}/{month}/{day}/prices', 'PUT',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType
      );
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/AnalyticStore}
     */
    this.setAnalytics = function(scope, year, month, day, opts) {
      return this.setAnalyticsWithHttpInfo(scope, year, month, day, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
