...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ErrorResponse', 'model/ResourceListOfScopeDefinition'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/ErrorResponse'), require('../model/ResourceListOfScopeDefinition'));
  } else {
    // Browser globals (root is window)
    if (!root.LusidSdk) {
      root.LusidSdk = {};
    }
    root.LusidSdk.ScopesApi = factory(root.LusidSdk.ApiClient, root.LusidSdk.ErrorResponse, root.LusidSdk.ResourceListOfScopeDefinition);
  }
}(this, function(ApiClient, ErrorResponse, ResourceListOfScopeDefinition) {
  'use strict';

  /**
   * Scopes service.
   * @module api/ScopesApi
   * @version 0.9.189
   */

  /**
   * Constructs a new ScopesApi. 
   * @alias module:api/ScopesApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ResourceListOfScopeDefinition} and HTTP response
     */
    this.listScopesWithHttpInfo = function(opts) {
      opts = opts || {};
      var postBody = null;
      ...
      var returnType = ResourceListOfScopeDefinition;
     ...
     * @param {String} opts.filter Optional. Expression to filter the result set
     * @param {String} opts.query Optional. Expression specifying the criteria that the returned portfolios must meet
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ResourceListOfScopeDefinition}
     */
    this.listScopes = function(opts) {
      return this.listScopesWithHttpInfo(opts)
