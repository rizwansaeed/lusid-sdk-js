...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CorporateActionSource', 'model/CreateCorporateAction', 'model/CreateCorporateActionSourceRequest', 'model/DeletedEntityResponse', 'model/ErrorResponse', 'model/ResourceListOfCorporateAction', 'model/ResourceListOfCorporateActionSource', 'model/UpsertCorporateActionsResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/CorporateActionSource'), require('../model/CreateCorporateAction'), require('../model/CreateCorporateActionSourceRequest'), require('../model/DeletedEntityResponse'), require('../model/ErrorResponse'), require('../model/ResourceListOfCorporateAction'), require('../model/ResourceListOfCorporateActionSource'), require('../model/UpsertCorporateActionsResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.LusidSdk) {
      root.LusidSdk = {};
    }
    root.LusidSdk.CorporateActionSourcesApi = factory(root.LusidSdk.ApiClient, root.LusidSdk.CorporateActionSource, root.LusidSdk.CreateCorporateAction, root.LusidSdk.CreateCorporateActionSourceRequest, root.LusidSdk.DeletedEntityResponse, root.LusidSdk.ErrorResponse, root.LusidSdk.ResourceListOfCorporateAction, root.LusidSdk.ResourceListOfCorporateActionSource, root.LusidSdk.UpsertCorporateActionsResponse);
  }
}(this, function(ApiClient, CorporateActionSource, CreateCorporateAction, CreateCorporateActionSourceRequest, DeletedEntityResponse, ErrorResponse, ResourceListOfCorporateAction, ResourceListOfCorporateActionSource, UpsertCorporateActionsResponse) {
  'use strict';

  /**
   * CorporateActionSources service.
   * @module api/CorporateActionSourcesApi
   * @version 0.9.189
   */

  /**
   * Constructs a new CorporateActionSourcesApi. 
   * @alias module:api/CorporateActionSourcesApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @param {Array.<module:model/CreateCorporateAction>} opts.actions The corporate action definitions
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/UpsertCorporateActionsResponse} and HTTP response
     */
    this.batchUpsertCorporateActionsWithHttpInfo = function(scope, code, opts) {
      opts = opts || {};
      var postBody = opts['actions'];

      // verify the required parameter 'scope' is set
      if (scope === undefined || scope === null) {
        throw new Error("Missing the required parameter 'scope' when calling batchUpsertCorporateActions");
      }

      // verify the required parameter 'code' is set
      if (code === undefined || code === null) {
        throw new Error("Missing the required parameter 'code' when calling batchUpsertCorporateActions");
      }
      ...
      var returnType = UpsertCorporateActionsResponse;
     ...
     * @param {Object} opts Optional parameters
     * @param {Array.<module:model/CreateCorporateAction>} opts.actions The corporate action definitions
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/UpsertCorporateActionsResponse}
     */
    this.batchUpsertCorporateActions = function(scope, code, opts) {
      return this.batchUpsertCorporateActionsWithHttpInfo(scope, code, opts)
     ...
     * @param {module:model/CreateCorporateActionSourceRequest} request The corporate action source definition
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/CorporateActionSource} and HTTP response
     */
    this.createCorporateActionSourceWithHttpInfo = function(request) {
      var postBody = request;

      // verify the required parameter 'request' is set
      if (request === undefined || request === null) {
        throw new Error("Missing the required parameter 'request' when calling createCorporateActionSource");
      }
      ...
      var contentTypes = ['application/json-patch+json', 'application/json', 'text/json', 'application/_*+json'];
      var accepts = ['text/plain', 'application/json', 'text/json'];
      var returnType = CorporateActionSource;
     ...
     * Attempt to create a corporate action source.
     * @param {module:model/CreateCorporateActionSourceRequest} request The corporate action source definition
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/CorporateActionSource}
     */
    this.createCorporateActionSource = function(request) {
      return this.createCorporateActionSourceWithHttpInfo(request)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @param {Object} opts Optional parameters
     * @param {Date} opts.effectiveAt Optional. The start effective date of the data
     ...
     */
    this.deleteCorporateActionSourceWithHttpInfo = function(scope, code, opts) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'scope' is set
      if (scope === undefined || scope === null) {
        throw new Error("Missing the required parameter 'scope' when calling deleteCorporateActionSource");
      }

      // verify the required parameter 'code' is set
      if (code === undefined || code === null) {
        throw new Error("Missing the required parameter 'code' when calling deleteCorporateActionSource");
      }
     ...
     */
    this.deleteCorporateActionSource = function(scope, code, opts) {
      return this.deleteCorporateActionSourceWithHttpInfo(scope, code, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @param {String} code The code of the corporate action source
     * @param {Object} opts Optional parameters
     * @param {Date} opts.fromEffectiveAt Optional. The start effective date of the data range
     * @param {Date} opts.toEffectiveAt Optional. The end effective date of the data range
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ResourceListOfCorporateAction} and HTTP response
     */
    this.getCorporateActionsWithHttpInfo = function(scope, code, opts) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'scope' is set
      if (scope === undefined || scope === null) {
        throw new Error("Missing the required parameter 'scope' when calling getCorporateActions");
      }

      // verify the required parameter 'code' is set
      if (code === undefined || code === null) {
        throw new Error("Missing the required parameter 'code' when calling getCorporateActions");
      }
      ...
      var contentTypes = [];
      var accepts = ['text/plain', 'application/json', 'text/json'];
      var returnType = ResourceListOfCorporateAction;
     ...
     * @param {Number} opts.limit Optional. When paginating, limit the number of returned results to this many
     * @param {String} opts.filter Optional. Expression to filter the result set
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ResourceListOfCorporateAction}
     */
    this.getCorporateActions = function(scope, code, opts) {
      return this.getCorporateActionsWithHttpInfo(scope, code, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @param {Object} opts Optional parameters
     * @param {Date} opts.effectiveAt Optional. The start effective date of the data range
     * @param {Date} opts.asAt Optional. The AsAt date of the data
     * @param {Array.<String>} opts.sortBy Optional. Order the results by these fields. Use use the &#39;-&#39; sign to denote descending order e.g. -MyFieldName
     * @param {Number} opts.start Optional. When paginating, skip this number of results
     * @param {Number} opts.limit Optional. When paginating, limit the number of returned results to this many
     * @param {String} opts.filter Optional. Expression to filter the result set
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ResourceListOfCorporateActionSource} and HTTP response
     */
    this.listCorporateActionSourcesWithHttpInfo = function(opts) {
      opts = opts || {};
      var postBody = null;
      ...
      var contentTypes = [];
      var accepts = ['text/plain', 'application/json', 'text/json'];
      var returnType = ResourceListOfCorporateActionSource;
     ...
     * @param {Number} opts.limit Optional. When paginating, limit the number of returned results to this many
     * @param {String} opts.filter Optional. Expression to filter the result set
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ResourceListOfCorporateActionSource}
     */
    this.listCorporateActionSources = function(opts) {
      return this.listCorporateActionSourcesWithHttpInfo(opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
