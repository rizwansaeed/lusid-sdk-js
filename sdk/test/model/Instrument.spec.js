...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LusidSdk.Instrument();
  });
  ...
  describe('Instrument', function() {
    it('should create an instance of Instrument', function() {
      ...
      //var instance = new LusidSdk.Instrument();
      //expect(instance).to.be.a(LusidSdk.Instrument);
    });
    ...
    it('should have the property lusidInstrumentId (base name: "lusidInstrumentId")', function() {
      // uncomment below and update the code to test the property lusidInstrumentId
      //var instance = new LusidSdk.Instrument();
      //expect(instance).to.be();
    });
    ...
    it('should have the property lookthroughPortfolio (base name: "lookthroughPortfolio")', function() {
      // uncomment below and update the code to test the property lookthroughPortfolio
      //var instance = new LusidSdk.Instrument();
      //expect(instance).to.be();
    });

    it('should have the property instrumentDefinition (base name: "instrumentDefinition")', function() {
      // uncomment below and update the code to test the property instrumentDefinition
      //var instance = new LusidSdk.Instrument();
      //expect(instance).to.be();
    });
