...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LusidSdk.CompletePortfolio();
  });
  ...
  describe('CompletePortfolio', function() {
    it('should create an instance of CompletePortfolio', function() {
      // uncomment below and update the code to test CompletePortfolio
      //var instance = new LusidSdk.CompletePortfolio();
      //expect(instance).to.be.a(LusidSdk.CompletePortfolio);
    });
