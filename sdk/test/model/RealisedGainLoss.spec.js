...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LusidSdk.RealisedGainLoss();
  });
  ...
  describe('RealisedGainLoss', function() {
    it('should create an instance of RealisedGainLoss', function() {
      // uncomment below and update the code to test RealisedGainLoss
      //var instance = new LusidSdk.RealisedGainLoss();
      //expect(instance).to.be.a(LusidSdk.RealisedGainLoss);
    });
    ...
    it('should have the property purchaseTradeDate (base name: "purchaseTradeDate")', function() {
      // uncomment below and update the code to test the property purchaseTradeDate
      //var instance = new LusidSdk.RealisedGainLoss();
      //expect(instance).to.be();
    });

    it('should have the property purchaseSettlementDate (base name: "purchaseSettlementDate")', function() {
      // uncomment below and update the code to test the property purchaseSettlementDate
      //var instance = new LusidSdk.RealisedGainLoss();
      //expect(instance).to.be();
    });
    ...
    it('should have the property costTradeCcy (base name: "costTradeCcy")', function() {
      // uncomment below and update the code to test the property costTradeCcy
      //var instance = new LusidSdk.RealisedGainLoss();
      //expect(instance).to.be();
    });

    it('should have the property costPortfolioCcy (base name: "costPortfolioCcy")', function() {
      // uncomment below and update the code to test the property costPortfolioCcy
      //var instance = new LusidSdk.RealisedGainLoss();
      //expect(instance).to.be();
    });

    it('should have the property realisedTradeCcy (base name: "realisedTradeCcy")', function() {
      // uncomment below and update the code to test the property realisedTradeCcy
      //var instance = new LusidSdk.RealisedGainLoss();
      //expect(instance).to.be();
    });

    it('should have the property realisedTotal (base name: "realisedTotal")', function() {
      // uncomment below and update the code to test the property realisedTotal
      //var instance = new LusidSdk.RealisedGainLoss();
      //expect(instance).to.be();
    });

    it('should have the property realisedMarket (base name: "realisedMarket")', function() {
      // uncomment below and update the code to test the property realisedMarket
      //var instance = new LusidSdk.RealisedGainLoss();
      //expect(instance).to.be();
    });

    it('should have the property realisedCurrency (base name: "realisedCurrency")', function() {
      // uncomment below and update the code to test the property realisedCurrency
      //var instance = new LusidSdk.RealisedGainLoss();
      //expect(instance).to.be();
    });
