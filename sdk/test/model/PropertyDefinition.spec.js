...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LusidSdk.PropertyDefinition();
  });
  ...
  describe('PropertyDefinition', function() {
    it('should create an instance of PropertyDefinition', function() {
      ...
      //var instance = new LusidSdk.PropertyDefinition();
      //expect(instance).to.be.a(LusidSdk.PropertyDefinition);
    });
    ...
    it('should have the property dataTypeId (base name: "dataTypeId")', function() {
      // uncomment below and update the code to test the property dataTypeId
      //var instance = new LusidSdk.PropertyDefinition();
      //expect(instance).to.be();
    });
