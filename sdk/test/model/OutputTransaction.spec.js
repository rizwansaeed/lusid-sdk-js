...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LusidSdk.OutputTransaction();
  });
  ...
  describe('OutputTransaction', function() {
    it('should create an instance of OutputTransaction', function() {
      // uncomment below and update the code to test OutputTransaction
      //var instance = new LusidSdk.OutputTransaction();
      //expect(instance).to.be.a(LusidSdk.OutputTransaction);
    });
    ...
    it('should have the property transactionToPortfolioRate (base name: "transactionToPortfolioRate")', function() {
      // uncomment below and update the code to test the property transactionToPortfolioRate
      //var instance = new LusidSdk.OutputTransaction();
      //expect(instance).to.be();
    });
    ...
    it('should have the property cancelDateTime (base name: "cancelDateTime")', function() {
      // uncomment below and update the code to test the property cancelDateTime
      //var instance = new LusidSdk.OutputTransaction();
      //expect(instance).to.be();
    });

    it('should have the property realisedGainLoss (base name: "realisedGainLoss")', function() {
      // uncomment below and update the code to test the property realisedGainLoss
      //var instance = new LusidSdk.OutputTransaction();
      //expect(instance).to.be();
    });
