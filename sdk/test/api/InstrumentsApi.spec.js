...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LusidSdk.InstrumentsApi();
  });
  ...
  describe('InstrumentsApi', function() {
    describe('deleteInstrument', function() {
      it('should call deleteInstrument successfully', function(done) {
        //uncomment below and update the code to test deleteInstrument
        //instance.deleteInstrument(function(error) {
    ...
    describe('findInstruments', function() {
      it('should call findInstruments successfully', function(done) {
        //uncomment below and update the code to test findInstruments
        //instance.findInstruments(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getInstrument', function() {
      it('should call getInstrument successfully', function(done) {
        //uncomment below and update the code to test getInstrument
        //instance.getInstrument(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getInstrumentIdentifiers', function() {
      it('should call getInstrumentIdentifiers successfully', function(done) {
        //uncomment below and update the code to test getInstrumentIdentifiers
        //instance.getInstrumentIdentifiers(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getInstruments', function() {
      it('should call getInstruments successfully', function(done) {
        //uncomment below and update the code to test getInstruments
        //instance.getInstruments(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('matchInstruments', function() {
      it('should call matchInstruments successfully', function(done) {
        //uncomment below and update the code to test matchInstruments
        //instance.matchInstruments(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('upsertInstruments', function() {
      it('should call upsertInstruments successfully', function(done) {
        //uncomment below and update the code to test upsertInstruments
        //instance.upsertInstruments(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('upsertInstrumentsProperties', function() {
      it('should call upsertInstrumentsProperties successfully', function(done) {
        //uncomment below and update the code to test upsertInstrumentsProperties
        //instance.upsertInstrumentsProperties(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
