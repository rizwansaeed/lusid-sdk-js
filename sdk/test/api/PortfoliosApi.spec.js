...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LusidSdk.PortfoliosApi();
  });
  ...
  describe('PortfoliosApi', function() {
    ...
    describe('deletePortfolioProperties', function() {
      it('should call deletePortfolioProperties successfully', function(done) {
        //uncomment below and update the code to test deletePortfolioProperties
        //instance.deletePortfolioProperties(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getPortfolioCommands', function() {
      it('should call getPortfolioCommands successfully', function(done) {
        //uncomment below and update the code to test getPortfolioCommands
        //instance.getPortfolioCommands(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getPortfolioProperties', function() {
      it('should call getPortfolioProperties successfully', function(done) {
        //uncomment below and update the code to test getPortfolioProperties
        //instance.getPortfolioProperties(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('listPortfoliosForScope', function() {
      it('should call listPortfoliosForScope successfully', function(done) {
        //uncomment below and update the code to test listPortfoliosForScope
        //instance.listPortfoliosForScope(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('upsertPortfolioProperties', function() {
      it('should call upsertPortfolioProperties successfully', function(done) {
        //uncomment below and update the code to test upsertPortfolioProperties
        //instance.upsertPortfolioProperties(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
